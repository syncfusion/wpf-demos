...
namespace TitleBarCustomization
{
    ...
    public class SearchControl : Control,IDisposable
    {
        ...
        /// <summary>
        /// Gets or sets the DataGrid for the corresponding search operation <see cref="SearchControl"/> class.
        /// </summary>
        ...
        /// </summary>
        /// <param name="sender">Text as parameter</param>
        ...
        /// </summary>
        /// <param name="sender">Search text box as parameter.</param>
        /// <param name="e">Event handler.</param>
