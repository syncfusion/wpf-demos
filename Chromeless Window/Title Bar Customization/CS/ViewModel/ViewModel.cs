...
namespace TitleBarCustomization
{
    ...
    public class ViewModel :NotificationObject
    {
        ...
        public static readonly DependencyProperty SfDataGridProperty =
            DependencyProperty.RegisterAttached("SfDataGrid", typeof(string), typeof(ViewModel), new FrameworkPropertyMetadata(OnSfDataGridChanged));
        ...
        /// <summary>
        /// Gets or sets the helpCommand <see cref="ViewModel"/>
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the textChangedCommand <see cref="ViewModel"/>
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the findNextCommand <see cref="ViewModel"/>
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the findPreviousCommand <see cref="ViewModel"/>
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the text <see cref="ViewModel"/>
        /// </summary>
        ...
        public List<OrderInfo> OrdersDetails
        {
            ...
            set { orderDetails = value; RaisePropertyChanged("OrdersDetails"); }
        }
