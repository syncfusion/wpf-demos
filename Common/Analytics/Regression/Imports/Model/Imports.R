...
imports_Regression<-lm(Price~ Symboling+ Normalized_Losses+Make+Fuel_Type+Aspiration+ Num_Of_Doors+Body_Style+Drive_Wheels+Wheel_Base+ Length+Width+Height+Curb_Weight+Engine_Size+ Bore+ Stroke+Compression_Ratio +Horse_Power+Peak_Rpm+City_Mpg+Highway_Mpg,data=trainData)	 								 					 
