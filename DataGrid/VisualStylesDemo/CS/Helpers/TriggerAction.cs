        ...
        protected override void Invoke(object parameter)
        {
            ...
            switch (cb.SelectedItem.ToString())
            {
                ...
                case "SystemTheme":
                    ...
                    break;
                case "MaterialLight":
                    SfSkinManager.SetVisualStyle(grid, VisualStyles.MaterialLight);
                    break;
                case "MaterialDark":
                    SfSkinManager.SetVisualStyle(grid, VisualStyles.MaterialDark);
                    break;
                case "MaterialDarkBlue":
                    SfSkinManager.SetVisualStyle(grid, VisualStyles.MaterialDarkBlue);
                    break;
                case "MaterialLightBlue":
                    SfSkinManager.SetVisualStyle(grid, VisualStyles.MaterialLightBlue);
                    break;
                default:
