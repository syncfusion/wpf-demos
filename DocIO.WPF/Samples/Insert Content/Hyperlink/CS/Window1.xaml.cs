...
namespace Hyperlinks
{
    ...
    public partial class Window1 : ChromelessWindow
    {
        ...
        {
            Process.Start(Application.ResourceAssembly.Location + @"..\..\Template.doc");
        }
        ...
        private void InsertHyperlink()
        {
            ...
            mImage1.LoadImage(System.Drawing.Image.FromFile(@"..\..\..\..\..\..\..\Common\Images\DocIO\\syncfusion_logo.gif"));
            ...
            mImage2.LoadImage(System.Drawing.Image.FromFile(@"..\..\..\..\..\..\..\Common\Images\DocIO\\google.png"));
            field = para.AppendField("Hyperlink", FieldType.FieldHyperlink);
            hyperLink = new Syncfusion.DocIO.DLS.Hyperlink(field as WField);
            hyperLink.Type = HyperlinkType.WebLink;
            hyperLink.Uri = "http://www.google.com";
            ...
            mImage3.LoadImage(System.Drawing.Image.FromFile(@"..\..\..\..\..\..\..\Common\Images\DocIO\yahoo.gif"));
            field = para.AppendField("Hyperlink", FieldType.FieldHyperlink);
            hyperLink = new Syncfusion.DocIO.DLS.Hyperlink(field as WField);
            hyperLink.Type = HyperlinkType.WebLink;
            ...
            hyperLink.FilePath = new DirectoryInfo(@"..\..\..\..\..\..\..\Common\Images\DocIO\DocIO.gif").FullName;
            ...
            hyperLink = new Syncfusion.DocIO.DLS.Hyperlink(field as WField);
            hyperLink.Type = HyperlinkType.FileLink;
            hyperLink.FilePath = new DirectoryInfo(@"..\..\..\..\..\..\..\Common\Images\DocIO\XlsIO.gif").FullName;
            ...
            hyperLink = new Syncfusion.DocIO.DLS.Hyperlink(field as WField);
            hyperLink.Type = HyperlinkType.FileLink;
            hyperLink.FilePath = new DirectoryInfo(@"..\..\..\..\..\..\..\Common\Images\DocIO\pdf.gif").FullName;
