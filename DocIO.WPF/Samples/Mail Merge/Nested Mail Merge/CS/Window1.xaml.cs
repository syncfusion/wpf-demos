...
namespace NestedMailMerge_2008
{
    /// <summary>
    ...
    public partial class Window1 : ChromelessWindow
    {
        ...
        public Window1()
        {
           ...
           // this.Width = System.Windows.SystemParameters.PrimaryScreenWidth * (0.36);
          //  this.Height = System.Windows.SystemParameters.PrimaryScreenHeight * (0.50);
        ...
        private void Button_Click1(object sender, RoutedEventArgs e)
        {
            if (MessageBox.Show("Do you want to view the Template document?", "Template document", MessageBoxButton.YesNo, MessageBoxImage.Information) == MessageBoxResult.Yes)
            {
                ...
                if (radioButtonLetter.IsChecked.Value)
                    System.Diagnostics.Process.Start(filePath + "Template_Letter.doc");
                else if (radioButtonReport.IsChecked.Value)
                    System.Diagnostics.Process.Start(filePath + "Template_Report.doc");
            }
        }
        # endregion
        /// <summary>
