                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            if (MessageBox.Show("Conversion Successful. Do you want to view the RTF File?", "Status", MessageBoxButton.YesNo, MessageBoxImage.Question) == MessageBoxResult.Yes)
                            {
                                ...
                                process.StartInfo = new System.Diagnostics.ProcessStartInfo("DocToRtf.rtf") { UseShellExecute = true };
                                process.Start();
#else
                        ...
                        catch (Exception ex)
                        {
                            if (ex is IOException)
                                MessageBox.Show("Please close the file (" + Directory.GetCurrentDirectory() + "\\DocToRtf.rtf" + ") then try generating the document.", "File is already open",
