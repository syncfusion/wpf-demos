...
namespace CustomizedScheduleAppearance
{
       public class Task : NotificationObject
    {
        ...
        public TimeSpan Duration
        {
            get
            {
                ...
                /// Difference between start date and end date calculated accurately.
        ...
        {
            /// Updating the start and end date, complete based on the chagne occur in the date of child task
