...
{
    /// <summary>
    /// Represents a load action for groupbar.
    /// </summary>
    public class GroupBarLoadAction : TriggerAction<Button>
    {
        /// <summary>
        /// Notifies the method which invokes the load action.
        /// </summary>
        /// <param name="parameter">Invokes the load action</param>
        protected override void Invoke(object parameter)
        {
            ...
            {
                GroupBarFields.LoadBarState();
            }
        }

        /// <summary>
        /// Gets and sets the target value <see cref="GroupBarLoadAction"/> class.
        /// </summary>
