...
namespace GroupbarOutlookDemo
{
    ...
    public class ViewModel : NotificationObject
    {
        ...
        /// <summary>
        /// Gets or sets the command for deleted mails <see cref="ViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for allMails <see cref="ViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for unReadMail <see cref="ViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for groupBarTabChangedCommand <see cref="ViewModel"/> class.
        /// </summary>
        public ICommand GroupBarTabChangedCommand
        {
            get { return groupBarTabChangedCommand; }
        }

        /// <summary>
        /// Gets or sets the collection of selected mails <see cref="ViewModel"/> class.
        /// </summary>
        public ObservableCollection<SortedMailCollection> SelectedMailCollection
        {
            get { return mainMailCollection; }
            set { mainMailCollection = value; RaisePropertyChanged("SelectedMailCollection"); }
        }

        /// <summary>
        /// Gets or sets the addContacts <see cref="ViewModel"/> class.
        /// </summary>
        public ObservableCollection<ContactModel> Contacts
        {
            get { return addContacts; }
            set { addContacts = value; RaisePropertyChanged("Contacts"); }
        }

        /// <summary>
        /// Gets or sets the notes <see cref="ViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the selected tree view item <see cref="ViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the sub items <see cref="ViewModel"/> class.
        /// </summary>
        public ObservableCollection<GroupbarSubItem> SubItems
        {
            get { return subItems; }
            set { subItems = value; RaisePropertyChanged("SubItems");
            }
        }

        /// <summary>
        /// Gets or sets the tree view details <see cref="ViewModel"/> class.
        /// </summary>
        public ObservableCollection<string> TreeViewDetails
        {
            get { return treeViewDetails; }
            set { treeViewDetails = value; RaisePropertyChanged("TreeViewDetails");
            }
        }
        ...
        private void TreeItemChanged(object value)
        {
            if (value.ToString() == "Sent Items")
                ...
                this.SelectedMailCollection = GetDeletedMails();
            else
                if (value.ToString() == "Drafts")
                this.SelectedMailCollection = GetDraftMails();
            else
                if (value.ToString() == "Junk Emails")
                this.SelectedMailCollection = GetJunkMails();
            else
        ...
        {
            ObservableCollection<MailCategory> addMails = new ObservableCollection<MailCategory>();
            addMails.Add(new MailCategory() { Header = "Inbox"});
            addMails.Add(new MailCategory() { Header = "Sent Items"});
            addMails.Add(new MailCategory() { Header = "Deleted Items" });
            addMails.Add(new MailCategory() { Header = "Drafts" });
            addMails.Add(new MailCategory() { Header = "Junk Emails" });
            addMails.Add(new MailCategory() { Header = "Outbox" });
        ...
        /// </summary>
        /// <returns>Returns </returns>
        private ObservableCollection<SortedMailCollection> GetDeletedMails()
        {
            ObservableCollection<SortedMailCollection> deletedMails = new ObservableCollection<SortedMailCollection>();
        ...
        /// </summary>
        /// <returns>Returns </returns>
        private ObservableCollection<SortedMailCollection> GetDraftMails()
        {
            ObservableCollection<SortedMailCollection> draftMails = new ObservableCollection<SortedMailCollection>();
        ...
        public void ExecuteGroupBarTabChange(object parameter)
        {
            ...
            if (mainWindow != null)
            {
                ...
                {
                    mainWindow.selectedControlContent.Content = new MailView() { DataContext = mainWindow.DataContext as ViewModel };
                }
                else if(mainWindow.groupBar.SelectedTab.HeaderText.ToString() == "Contacts")
                {
                    mainWindow.selectedControlContent.Content = null; mainWindow.selectedControlContent.Content = new ContactsView() { DataContext = mainWindow.DataContext as ViewModel };
                }
                ...
                {
                    mainWindow.selectedControlContent.Content = null; mainWindow.selectedControlContent.Content = new NotesView() { DataContext = mainWindow.DataContext as ViewModel };
                }
            }
        }
    }
