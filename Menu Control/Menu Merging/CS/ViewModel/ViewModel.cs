...
namespace MenuMerging
{
    public class ViewModel: NotificationObject
    {
        ...
        public ViewModel()
        {
            ...
            FileModel = new CommandModel() { Name = "File" };
            FileModel.Commands.Add(new CommandModel() { Name = "New Product Details", Icon = "/Images/NewDocumentHS.png", Command = NewGridCommand });
            FileModel.Commands.Add(new CommandModel() { Name = "New product Statistics", Icon = "/Images/graphhs.png", Command = NewChartCommand });
            FileModel.Commands.Add(new CommandModel() { Name = "Open", Icon = "/Images/openfolderHS.png",Command=NewCommand });
            FileModel.Commands.Add(new CommandModel() { Name = "Exit", Icon = "/Images/DeleteHS.png",Command=NewCommand });

            WindowModel = new CommandModel() { Name = "Windows" };
            WindowModel.Commands.Add(new CommandModel() { Name = "Cascade", Icon = "/Images/CascadeWindowsHS.png", Command = TileCascade, IsCheckable=true });
            WindowModel.Commands.Add(new CommandModel() { Name = "Tile Horizontally", Icon = "/Images/ArrangeWindowsHS.png", Command = TileHorizontal, IsCheckable = true });
            WindowModel.Commands.Add(new CommandModel() { Name = "Tile Vertically", Icon = "/Images/ArrangeSideBySideHS.png", Command = TileVertical, IsCheckable = true });

            WindowModel.Commands[0].PropertyChanged+=new PropertyChangedEventHandler(ViewModel_PropertyChanged);
            WindowModel.Commands[1].PropertyChanged += new PropertyChangedEventHandler(ViewModel_PropertyChanged);
            WindowModel.Commands[2].PropertyChanged += new PropertyChangedEventHandler(ViewModel_PropertyChanged);
            ...
            HelpModel = new CommandModel() { Name = "Help" };
            HelpModel.Commands.Add(new CommandModel() { Name = "Online Help", Icon = "/Images/Help.png", Command =NewCommand});
            HelpModel.Commands.Add(new CommandModel() { Name = "About", Icon = "", Command =NewCommand});

            OtherCommands = new ObservableCollection<CommandModel>();
            OtherToolbarCommands = new ObservableCollection<CommandModel>();
            OtherCommands.Add(FileModel);
            FileCommands = FileModel.Commands;
            OtherCommands.Add(WindowModel);
            WindowCommands = WindowModel.Commands;
        }
        ...
        public CommandModel FileModel { get; set; }

        public CommandModel WindowModel { get; set; }
        ...
        public CommandModel HelpModel { get; set; }
