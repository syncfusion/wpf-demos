            ...
            if (win != null && cb != null)
            {
                switch (cb.SelectedItem.ToString())
                {
                    ...
                    case "SystemTheme":
                        ...
                        break;
                    case "Material Light":
                        SfSkinManager.SetVisualStyle(win, VisualStyles.MaterialLight);
                        break;
                    case "Material Light Blue":
                        SfSkinManager.SetVisualStyle(win, VisualStyles.MaterialLightBlue);
                        break;
                    case "Material Dark":
                        SfSkinManager.SetVisualStyle(win, VisualStyles.MaterialDark);
                        break;
                    case "Material Dark Blue":
                        SfSkinManager.SetVisualStyle(win, VisualStyles.MaterialDarkBlue);
                        break;
                    default:
