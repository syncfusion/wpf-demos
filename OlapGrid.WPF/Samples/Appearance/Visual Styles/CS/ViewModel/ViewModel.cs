...
namespace VisualStyles.ViewModel
{
    ...
    public class ViewModel : NotificationObject, IDisposable
    {
        ...
        public IEnumerable<String> OlapGridVisualStyles
        {
            get
            {
                return new List<string>() { "Blend", "Metro", "Office2010Black", "Office2010Blue", "Office2010Silver", "Office2013LightGray", "Office2013DarkGray", "Office2013White", "VisualStudio2013", "Office365", "Office2016White", "Office2016DarkGray", "Office2016Colorful", "VisualStudio2015" };
            }
        }
        #endregion
