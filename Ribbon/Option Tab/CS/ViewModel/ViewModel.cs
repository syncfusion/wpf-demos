...
namespace RibbonSample
{
    ...
    {      
        /// <summary>
        /// Maintains the command for save backstage item.
        /// </summary>
        ...
        /// </summary>
        private ObservableCollection<OptionTab> optionTabs;
        ...
        /// <summary>
        /// Gets or sets the display tab content <see cref="ViewModel" /> class.
        /// </summary>     
        public DisplayTabContent DisplayTabContent { get; set; }

        /// <summary>
        /// Gets or sets the general tab content <see cref="ViewModel" /> class.
        /// </summary>
        public GeneralTabContent GeneralTabContent { get; set; }

        /// <summary>
        /// Gets or sets the collection of option tab <see cref="ViewModel" /> class.
        /// </summary>
        public ObservableCollection<OptionTab> OptionTabsCollection { get { return optionTabs; } set { optionTabs = value; RaisePropertyChanged("OptionTabsCollection"); } }
        ...
        /// <summary>
        /// Gets or sets the command for save backstage command button <see cref="ViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Mthod which is used to execute the save command.
        /// </summary>
        /// <param name="parameter">Specifies the parameter of save command.</param>
