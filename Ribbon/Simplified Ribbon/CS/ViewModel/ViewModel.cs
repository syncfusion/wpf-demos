...
namespace RibbonSample
{
    ...
    {      
        ...
        /// <summary>
        /// Gets or sets the title text <see cref="ViewModel"/> class.
        /// </summary>
        public string TitleText { get; set; }

        /// <summary>
        /// Gets or sets the first paragraph <see cref="ViewModel"/> class.
        /// </summary>
        public string FirstParagraphText { get; set; }

        /// <summary>
        /// Gets or sets the second title <see cref="ViewModel"/> class.
        /// </summary>
        public string SecondTitleText { get; set; }

        /// <summary>
        /// Gets or sets the point one <see cref="ViewModel"/> class.
        /// </summary>
        public string PointOne { get; set; }

        /// <summary>
        /// Gets or sets the point two <see cref="ViewModel"/> class.
        /// </summary>
        public string PointTwo { get; set; }

        /// <summary>
        /// Gets or sets the point three <see cref="ViewModel"/> class.
        /// </summary>
        public string PointThree { get; set; }

        /// <summary>
        /// Gets or sets the point four <see cref="ViewModel"/> class.
        /// </summary>
        public string PointFour { get; set; }

        /// <summary>
        /// Gets or sets the point five <see cref="ViewModel"/> class.
        /// </summary>
        public string PointFive { get; set; }

        /// <summary>
        /// Gets or sets the point six <see cref="ViewModel"/> class.
        /// </summary>
        public string PointSix { get; set; }

        /// <summary>
        /// Gets or sets the point seven <see cref="ViewModel"/> class.
        /// </summary>
        public string PointSeven { get; set; }

        /// <summary>
        /// Gets or sets the point eight <see cref="ViewModel"/> class.
        /// </summary>
        public string PointEight { get; set; }

        /// <summary>
        /// Gets or sets the point nine <see cref="ViewModel"/> class.
        /// </summary>
