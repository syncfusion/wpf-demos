...
namespace GettingStarted_SequenceDiagram.ViewModel
{
   public class SequenceDiagram:DiagramViewModel
    {
        ...
        private void CreateNodesandConnections()
        {
            ...
            ConnectorViewModel connector3 = Connect(node1, node8, label1: "c3", style: App.Current.Resources["GetGrayLineStyle"] as Style);
            ConnectorViewModel connector4 = Connect(node2, node9, label1: "c4", style: App.Current.Resources["GetGrayLineStyle"] as Style);
            ConnectorViewModel connector5 = Connect(node3, node10, label1: "c5", style: App.Current.Resources["GetGrayLineStyle"] as Style);
            ConnectorViewModel connector6 = Connect(node4, node11, label1: "c6", style: App.Current.Resources["GetGrayLineStyle"] as Style);
            ...
            ConnectorViewModel connector1 = Connect(node5, node6, headport: port111, tailport: port2, label2: "Check Employee availability and task status", style: App.Current.Resources["GetBlueLineStyle"] as Style, margin: new Thickness(0, 20, 0, 0));
            ConnectorViewModel connector2 = Connect(node5, node7, headport: port12, tailport: port3, label2: "Forward Leave Request", style: App.Current.Resources["GetBlueLineStyle"] as Style, margin: new Thickness(0, 10, 0, 0));
            ConnectorViewModel connector7 = Connect(node26, node5, headport: port11, tailport: port1, label2: "Leave Request", style: App.Current.Resources["GetBlueLineStyle"] as Style, margin: new Thickness(0, 10, 0, 0));
        ...
        private ConnectorViewModel Connect(NodeViewModel headnode, NodeViewModel tailnode, NodePort headport = null, NodePort tailport = null, ConnectorViewModel connector = null, ConnectorPort connectorheadport = null, ConnectorPort connectortailport = null, String label1 = null, String label2 = null, Style style = null, Thickness margin = new Thickness())
        {
            ...
            Connectorviewmodel.TargetDecoratorStyle = App.Current.Resources["DecoratorStyle"] as Style;
        ...
        private NodePort addPort(NodeViewModel node, double offsetX, double offsetY)
        {
            NodePort nodeport = new NodePort()
            {
                ...
                NodeOffsetY = offsetY,
                Node = node,
                ShapeStyle = App.Current.Resources["GetPortStyle"] as Style,
            };
            return nodeport;
        }
        ...
        private NodeViewModel AddNode(double height, double width, double offx, double offy, string label = null, Style style = null)
        {
            ...
            Nodeviewmodel.Annotations = new ObservableCollection<IAnnotation>()
            {
                new AnnotationEditorViewModel()
                {
                    ...
                    WrapText= TextWrapping.Wrap,
                    ReadOnly = true,
                    ViewTemplate=App.Current.Resources["BoldedAnnotationTemplate"] as DataTemplate,                    
                }
            };
