...
using ColumnSizerDemo.DataModel;
        ...
        private void PopulateData()
        {
            if (!LayoutControl.IsInDesignMode)
            {
                ...
                foreach (OrderDetails orderDet in north.OrderDetails.Take(150))
                {
                    ...
                    if ((double)orderDet.Orders.Freight < 50)
                        orderInfo.Freight = (double)orderDet.Orders.Freight;
                    else
                        orderInfo.Freight = r.Next(10,100) - (double)orderDet.Orders.Freight;
                    ...
                    orderInfo.IsClosed = r.Next() % 2 == 0 ? false : true;
