...
namespace DiagramBuilder.View
{
    ...
    public class ThemeCheckBox : RibbonCheckBox
    {
        ...
        {
            (Application.Current.MainWindow.DataContext as DiagramBuilderVM).IsApplyTheme = true;
        }
        ...
        {
            (Application.Current.MainWindow.DataContext as DiagramBuilderVM).IsApplyTheme = false;
        }
    }
}