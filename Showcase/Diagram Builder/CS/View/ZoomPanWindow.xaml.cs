...
namespace DiagramBuilder.View
{
    ...
    public partial class ZoomPanWindow : Window
    {
        ...
        {
            ZoomParameter param = ((this.DataContext as MainWindow).DataContext as DiagramBuilderVM).ZoomParameter;
            ...
            ((this.DataContext as MainWindow).DataContext as DiagramBuilderVM).OnZoomCommand(this.textbox.Text);
            ((this.DataContext as MainWindow).DataContext as DiagramBuilderVM).Isopen = true;
            this.Close();
        }
        ...
        {
            this.Owner = this.DataContext as MainWindow;
        }
    }
}