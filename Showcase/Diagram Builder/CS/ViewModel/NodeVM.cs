...
namespace DiagramBuilder.ViewModel
{
    ...
    public class NodeVM : NodeViewModel, INodeVM, IUndoRedo
    {
        ...
        public NodeVM()
        {
            ...
            if (Application.Current.MainWindow.DataContext is DiagramBuilderVM)
            {
                bool value = (Application.Current.MainWindow.DataContext as DiagramBuilderVM).IsApplyTheme;
                if (value)
                {
