    ...
    Partial Public Class Window11
        ...
        Private Sub mnulg1_Click(ByVal sender As Object, ByVal e As RoutedEventArgs)
            ...
            Select Case menuitem.Header.ToString()
                Case "CSharp"
                    Edit1.DocumentLanguage = Syncfusion.Windows.Edit.Languages.CSharp
                Case "Visual Basic"
                    Edit1.DocumentLanguage = Syncfusion.Windows.Edit.Languages.VisualBasic
                Case "Text"
                    Edit1.DocumentLanguage = Syncfusion.Windows.Edit.Languages.Text
                Case "XAML"
                    Edit1.DocumentLanguage = Syncfusion.Windows.Edit.Languages.XAML
                Case "XML"
                    Edit1.DocumentLanguage = Syncfusion.Windows.Edit.Languages.XML
                Case "Custom"
                    Edit1.DocumentLanguage = Syncfusion.Windows.Edit.Languages.Custom
                    Edit1.CustomLanguage = TryCast(Me.Resources("symbolslang"), EditLanguage)
            End Select
            UnCheckAll()
