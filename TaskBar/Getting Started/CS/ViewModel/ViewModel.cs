...
namespace TaskBarDemo
{
    ...
    public class ViewModel : NotificationObject
    {
        ...
        public ViewModel()
        {
            taskBarItemChanged = new DelegateCommand<object>(ExecuteEventLog);
        }

        /// <summary>
        /// Gets or sets the eventLog <see cref="ViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the eventlog when selection changes in task bar <see cref="ViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the selected value <see cref="ViewModel"/> class.
        /// </summary>
