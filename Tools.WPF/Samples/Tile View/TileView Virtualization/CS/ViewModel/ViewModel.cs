...
namespace TileViewVirtualization
{
    public class ViewModel :NotificationObject
    {
        ...
        public ViewModel()
        {
            ...
            PopulateData();
            LoadCities();
            _employeeDetails = GetEmployeesDetails(100000);
        }
        ...
        public ObservableCollection<Employee> GetEmployeesDetails(int count)
        {
            ...
            for (var i = 1; i <= count; i++)
            {
                ...
                {
                    employees[i-1].MinimizedProfileImage = "../Images/male.png";
                    employees[i - 1].MaximizedProfileImage = "../Images/malemax.png";
                    employees[i - 1].City = Cities[_ccount];
                    employees[i - 1].EmailID = employees[i - 1].Name.Replace(" ", string.Empty).ToLower() +"@empsoft.com";
                }
                else
                {
                    employees[i-1].MinimizedProfileImage = "../Images/female.png";
                    employees[i - 1].MaximizedProfileImage = "../Images/femalemax.png";
                    employees[i - 1].City = Cities[_ccount];
