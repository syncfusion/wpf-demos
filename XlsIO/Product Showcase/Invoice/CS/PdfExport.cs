...
Tel +1 888.936.8638 Fax +1 919.573.0306");
...
#if NETCORE
            Stream imgStream = new FileStream("../../../Assets/SyncfusionLogo.jpg", FileMode.Open, FileAccess.Read);
#else
            Stream imgStream = new FileStream("../../Assets/SyncfusionLogo.jpg", FileMode.Open, FileAccess.Read);
#endif
                 ...
                 MessageBoxButton.YesNo, MessageBoxImage.Information) == MessageBoxResult.Yes)
            {
                ...
                process.StartInfo = new System.Diagnostics.ProcessStartInfo("Invoice.pdf")
                {
