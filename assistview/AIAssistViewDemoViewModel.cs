...
namespace syncfusion.assistviewdemo.wpf
{
    ...
    public class AIAssistViewProductDemos : ProductDemo
    {
        public AIAssistViewProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", Tag = Tag.New, IsAISample = true, Description = "This sample demonstrates the default functionality of the AIAssistView component, offering a simple chat interface for communicating with an AI device.", GroupName = "AssistView", DemoViewType = typeof(AssistViewDemo) });
            this.Demos.Add(new DemoInfo() { SampleName = "Reservation", Tag = Tag.New, Description = "This sample demonstrates a reservation chatbot that provides a user-friendly interface for booking appointments and managing reservations. ", GroupName = "AssistView", DemoViewType = typeof(ComposeView) });
            this.Demos.Add(new DemoInfo() { SampleName = "Flyout", Tag = Tag.New, IsAISample = true, Description = "This sample showcases how to host the AIAssistView in a flyout seamlessly integrating it into an application while minimizing space usage.", GroupName = "AssistView", DemoViewType = typeof(Overview) });
