  ...
  ""required"": [
    ...
    ""Suggestions""
        ...
        public async Task Initialize()
        {
            ...
            if (AISettings.IsCredentialValid)
            {
                await AISettings.ClientAI.GetResponseAsync(Requirement);
            }
        ...
        Random r = new Random();
        public async Task<T> NonStreamingChat(string line, bool fileUploaded = false)
        {
            ...
            try
            {
                ...
                if (AISettings.IsCredentialValid)
                {
                    ...
                    var response = await AISettings.ClientAI.GetResponseAsync(Requirement);
