...
namespace syncfusion.avatarviewdemo.wpf
{
    ...
    public class AvatarViewProductDemos : ProductDemo
    {
        public AvatarViewProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Initials", Tag = Tag.New, IsAISample = false, Description = "This sample demonstrates the initials content type for AvatarView and its customization.", GroupName = "AvatarView", DemoViewType = typeof(InitialsDemo) });
            this.Demos.Add(new DemoInfo() { SampleName = "Avatar Character", Tag = Tag.New, IsAISample = false, Description = "This sample demonstrates the predefined avatar characters available in AvatarView and their customization.", GroupName = "AvatarView", DemoViewType = typeof(AvatarCharacterDemo) });
            this.Demos.Add(new DemoInfo() { SampleName = "Custom Image", Tag = Tag.New, IsAISample = false, Description = "This sample demonstrates how to add custom images as avatars, replacing initials with user-defined images in AvatarView and customizing them.", GroupName = "AvatarView", DemoViewType = typeof(CustomImageDemo) });
            this.Demos.Add(new DemoInfo() { SampleName = "GroupView", Tag = Tag.New, Description = "This sample showcases the various group view representations of avatar view control. ", GroupName = "AvatarView", DemoViewType = typeof(GroupViewDemo) });
        }
    }
}
