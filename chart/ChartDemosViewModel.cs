...
namespace syncfusion.chartdemos.wpf
{
    ...
    public class ChartProductDemos : ProductDemo
    {
        public ChartProductDemos()
        {
            ...
            DemoInfo barWidthSample = new DemoInfo() { SampleName = "Bar spacing", GroupName = "Basic Charts", Description = "This sample illustrates the percentage growth of remote work between 2020 and 2012, with customized segment spacing.", DemoViewType = typeof(BarWidthCustomization) };
            ...
            DemoInfo rangeBarDemo = new DemoInfo() { SampleName = "Range Bar", GroupName = "Basic Charts", WhatsNewDescription= "This sample shows a radial bar chart, a variation of the doughnut chart. It utilizes separate circles for each segment to compare values across different categories.",
                Description = "This transposed range column chart demonstrates the temperature variation in Paris in degrees Celsius.", DemoViewType = typeof(RangeBar),Tag=Tag.New, };
            ...
            DemoInfo pyramidLegendDemo = new DemoInfo() { SampleName = "Customized Pyramid", GroupName = "Pyramid Charts", WhatsNewDescription= "This sample showcases a pyramid chart with different mode options and customized tooltips and data labels.",
                Description = "This sample showcases a pyramid chart with different mode options and customized tooltips that offer additional information about the distribution of operation costs across categories in the year 2020.", DemoViewType = typeof(PyramidMode), Tag=Tag.New, };
            ...
            DemoInfo funnelLegendDemo = new DemoInfo() { SampleName = "Customized Funnel", GroupName = "Funnel Charts", WhatsNewDescription= "This sample showcases a funnel chart with different mode options and customized tooltips and data labels.",
                Description = "This funnel chart showcases the various stages of the sales funnel, with mode options and customized tooltips that provide additional information about each stage.", DemoViewType = typeof(FunnelMode),Tag=Tag.New, };
            ...
            DemoInfo OHLCDemo = new DemoInfo() { SampleName = "OHLC", GroupName = "Financial Charts", Description = "This sample illustrates the stock information of ABM Industries in 2020 using an OHLC chart.", DemoViewType = typeof(HiLoOpenCloseChartDemo) };
            ...
            DemoInfo legendToggleSample = new DemoInfo() { SampleName = "Default Legend", GroupName = "Legend", WhatsNewDescription= "This sample showcases the toggled legend, which allows individuals to enable or disable series by tapping on the legend.",
                Description = "This sample illustrates a sales comparison in a fruit shop with toggle functionality, which allows for enabling or disabling series by tapping on the legend.", DemoViewType = typeof(ToggledLegend),Tag=Tag.New, };
            ...
            DemoInfo customizedLegendSample = new DemoInfo() { SampleName = "Customized Legend", GroupName = "Legend", WhatsNewDescription= "This sample showcases the customized legend, which allows individuals to personalize both its appearance and content to suit their preferences.",
                Description = "This sample visualizes the production of automobiles by category, with a customized legend that provides additional information about productivity.", DemoViewType = typeof(CustomizedLegend),Tag=Tag.New };
