...
namespace syncfusion.chartdemos.wpf
{
    ...
    public class Three_DChartProductDemos : ProductDemo
    {
        public Three_DChartProductDemos()
        {
            ...
            DemoInfo categoryAxis3DDemo = new DemoInfo() { SampleName = "Category Axis", Tag = Tag.New, GroupName = "Axis", DemoViewType=typeof(CategoryAxis3DChart) , Description= "Using a category axis, this sample demonstrates the world's most active volcanoes since 1950 across different countries.",
            ...
            DemoInfo dateTimeAxis3DDemo = new DemoInfo() { SampleName = "DateTime Axis", Tag = Tag.New, GroupName = "Axis", DemoViewType=typeof(DateTimeAxis3DChart) , Description= "This sample demonstrates the production trends of different food items on a monthly basis using a date-time axis.",
            ...
            DemoInfo logAxis3DDemo = new DemoInfo() { SampleName = "Logarithmic Axis", Tag = Tag.New, GroupName = "Axis", DemoViewType = typeof(LogaritmicAxis3DChart), Description = "This sample illustrates the growth of a product throughout a period, from 2005 to 2015, using a logarithmic axis.",
