...
{
    /// <summary>View model that supplies the list of chart demo groups.</summary>
    public class ChartDemosViewModel : DemoBrowserViewModel
    {
        /// <summary>Returns the catalog of product demo groups for Charts.</summary>
    ...
    /// <summary>Defines the Charts product group and its metadata for the demo browser.</summary>
    public class ChartProductDemos : ProductDemo
    {
        /// <summary>Initializes metadata and demo list for the Charts product group.</summary>
        public ChartProductDemos()
        {
            ...
            { 
                SampleName = "OHLC", 
                GroupName = "Fast Charts", 
                Description = "This sample showcases stock market trends in the cosmetics industry using a fast OHLC series and effectively manages large quantities of data.", 
    ...
    /// <summary>Defines the 3D Charts product group and its metadata.</summary>
    public class Three_DChartProductDemos : ProductDemo
    {
        /// <summary>Initializes metadata and demo list for the 3D Charts product group.</summary>
    ...
    /// <summary>Defines the Range Navigator product group and its metadata.</summary>
    public class SFDateTimeRangeNavigatorDemo : ProductDemo
    {
        /// <summary>Initializes metadata and demo list for the Range Navigator product group.</summary>
