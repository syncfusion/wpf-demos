...
{
    /// <summary>Provides a data source for annotation tooltips in the chart.</summary>
    public class AnnotationToolTipViewModel : IDisposable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AnnotationToolTipViewModel"/> class.
        /// </summary>
        ...
        /// <summary>Gets or sets the collection of tooltip data items.</summary>
