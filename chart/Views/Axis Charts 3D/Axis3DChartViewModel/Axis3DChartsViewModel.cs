...
{
    /// <summary>Provides multiple datasets for 3D axis chart demonstrations (category, numeric, and log).</summary>
    public class Axis3DChartsViewModel : IDisposable
    {
        /// <summary>Gets or sets the volcanoes per country dataset.</summary>
        public List<Axis3DChartsModel> VolcanoesData { get; set; }

        /// <summary>Gets or sets the cricket match scores dataset.</summary>
        public ObservableCollection<Axis3DChartsModel> MatchScores { get; set; }

        /// <summary>Gets or sets the sales rate dataset.</summary>
        public ObservableCollection<Axis3DChartsModel> DataCollection { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="Axis3DChartsViewModel"/> class.
        /// </summary>
