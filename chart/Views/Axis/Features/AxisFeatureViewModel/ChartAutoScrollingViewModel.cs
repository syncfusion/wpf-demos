...
{
    /// <summary>Streams time-series data and drives auto-scrolling behavior.</summary>
    public class ChartAutoScrollingViewModel : ObservableCollection<ChartAutoScrollingModel>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChartAutoScrollingViewModel"/> class.
        /// </summary>
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            this.Add(new ChartAutoScrollingModel() { Speed = currentDate, Rate = rand.Next(110, 240) });
        }
    }
}
