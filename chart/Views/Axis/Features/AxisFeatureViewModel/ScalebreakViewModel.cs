...
{
    /// <summary>Provides data and settings for demonstrating axis scale breaks.</summary>
    public class ScalebreakViewModel : NotificationObject, IDisposable
    {
        /// <summary>Gets or sets the current scale break position mode.</summary>
        ...
        /// <summary>Gets or sets the visibility of the percentage input UI.</summary>
        ...
        /// <summary>Gets or sets the collection of mountain elevation records.</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScalebreakViewModel"/> class.
        /// </summary>
        ...
        public void Dispose()
        {
            if(MountainsElevationsDetails != null)
                MountainsElevationsDetails.Clear();
        }
    }
}
