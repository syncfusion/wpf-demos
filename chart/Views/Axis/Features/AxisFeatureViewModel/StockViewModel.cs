...
{
    /// <summary>Loads and exposes stock data for axis feature demonstrations.</summary>
    public class StockViewModel : NotificationObject
    {
        ...
        /// <summary>Gets or sets the current stock with its data and stats.</summary>
        public Stock Stocks
        {
            get
            {
        ...
        /// <summary>Parses stock data from a file into a list of records.</summary>
