...
{
    /// <summary>Provides datasets demonstrating category, numeric, date/time, and log axes.</summary>
    public class AxisViewModel : IDisposable
    {
        /// <summary>Gets or sets the dataset for category axis (internet users).</summary>
        public ObservableCollection<AxisModel> InternetUsers { get; set; }

        /// <summary>Gets or sets the dataset for numeric axis (match scores).</summary>
        public ObservableCollection<AxisModel> MatchScores { get; set; }

        /// <summary>Gets or sets the dataset for DateTime axis (EUR to USD).</summary>
        public ObservableCollection<AxisModel> EuroToUSDValue { get; set; }

        /// <summary>Gets or sets the dataset for DateTimeCategory axis (sales revenue).</summary>
        public ObservableCollection<AxisModel> SalesRevenue { get; set; }

        /// <summary>Gets or sets the dataset for log axis (sales rate).</summary>
        ...
        public void Dispose()
        {
            ...
            if (EuroToUSDValue != null)
                EuroToUSDValue.Clear();
