...
{
    /// <summary>Provides sample data for a 3D area series chart.</summary>
    public class AreaSeriesChart3DViewModel : IDisposable
    {
        /// <summary>Gets or sets the 3D area chart data.</summary>
        public ObservableCollection<AreaSeriesChart3DModel> AreaData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="AreaSeriesChart3DViewModel"/> class.
        /// </summary>
