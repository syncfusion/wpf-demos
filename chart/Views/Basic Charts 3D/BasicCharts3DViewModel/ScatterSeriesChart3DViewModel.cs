...
{
    /// <summary>Provides two datasets for 3D scatter series comparisons.</summary>
    public class ScatterSeriesChart3DViewModel : IDisposable
    {
        /// <summary>Gets or sets Team A data points.</summary>
        public ObservableCollection<ScatterSeriesChart3DModel> TeamA { get; set; }

        /// <summary>Gets or sets Team B data points.</summary>
        public ObservableCollection<ScatterSeriesChart3DModel> TeamB { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="ScatterSeriesChart3DViewModel"/> class.
        /// </summary>
