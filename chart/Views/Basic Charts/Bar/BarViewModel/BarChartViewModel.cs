...
{
    /// <summary>Provides datasets for default, rounded, and spaced bar charts.</summary>
    public class BarChartViewModel : IDisposable
    {
        /// <summary>Gets the default bar chart data.</summary>
        public ObservableCollection<BarChartModel> DefaultBarData { get; }

        /// <summary>Gets or sets the rounded bar chart data.</summary>
        public ObservableCollection<BarChartModel> RoundedBarData { get; set; }

        /// <summary>Gets or sets the bar width/spacing data.</summary>
