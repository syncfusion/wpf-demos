...
{
    /// <summary>Provides datasets and options for box-and-whisker charts.</summary>
    public class BoxWhiskerChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the collection of data sets.</summary>
        public ObservableCollection<BoxWhiskerChartModel> DataSets { get; set; }

        /// <summary>Gets the available box plot modes.</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BoxWhiskerChartViewModel"/> class.
        /// </summary>
