...
{
    /// <summary>Provides bubble chart datasets for multiple categories.</summary>
    public class BubbleChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the GDP growth dataset.</summary>
        public ObservableCollection<BubbleChartModel> GDPGrowthCollection { get; set; }

        /// <summary>Gets or sets the action genre dataset.</summary>
        public ObservableCollection<BubbleChartModel> ActionData { get; set; }

        /// <summary>Gets or sets the horror genre dataset.</summary>
        public ObservableCollection<BubbleChartModel> HorrorData { get; set; }

        /// <summary>Gets or sets the science fiction genre dataset.</summary>
        public ObservableCollection<BubbleChartModel> ScienceFictionData { get; set; }

        /// <summary>Gets or sets the thriller genre dataset.</summary>
        public ObservableCollection<BubbleChartModel> ThrillerData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="BubbleChartViewModel"/> class.
        /// </summary>
