...
{
    /// <summary>Provides the sample data used to build a histogram.</summary>
    public class HistogramChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the histogram data collection.</summary>
        public ObservableCollection<HistogramChartModel> HistogramData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="HistogramChartViewModel"/> class.
        /// </summary>
