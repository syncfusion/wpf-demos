...
{
    /// <summary>Provides datasets for default and dashed line chart examples.</summary>
    public class LineChartViewModel : IDisposable
    {
        /// <summary>Gets the Romania dataset.</summary>
        public ObservableCollection<LineChartModel> RomaniaData { get; }

        /// <summary>Gets the Norway dataset.</summary>
        public ObservableCollection<LineChartModel> NorwayData { get; }

        /// <summary>Gets or sets the dashed multi-series dataset.</summary>
