...
{
    /// <summary>Provides datasets for range column and range bar charts.</summary>
    public class RangeColumnChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the range column dataset.</summary>
        public ObservableCollection<RangeColumnChartModel> RangeColumnData { get; set; }

        /// <summary>Gets or sets the range bar dataset.</summary>
        public ObservableCollection<RangeColumnChartModel> RangeBarData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="RangeColumnChartViewModel"/> class.
        /// </summary>
