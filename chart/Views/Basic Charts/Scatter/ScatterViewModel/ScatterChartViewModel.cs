...
{
    /// <summary>Provides male and female datasets for scatter chart demonstrations.</summary>
    public class ScatterChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the male data points.</summary>
        public ObservableCollection<ScatterModel> MaleData { get; set; }

        /// <summary>Gets or sets the female data points.</summary>
        public ObservableCollection<ScatterModel> FemaleData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="ScatterChartViewModel"/> class.
        /// </summary>
