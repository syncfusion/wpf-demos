...
{
    /// <summary>Provides data for spline area chart demonstrations.</summary>
    public class SplineAreaChartViewModel : IDisposable
    {
        /// <summary>Gets the spline area data collection.</summary>
        public ObservableCollection<SplineAreaChartModel> SplineAreaData { get; }

        /// <summary>
        /// Initializes a new instance of the <see cref="SplineAreaChartViewModel"/> class.
        /// </summary>
