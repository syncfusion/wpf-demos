...
{
    /// <summary>Provides date-based high/low data for spline range area charts.</summary>
    public class SplineRangeAreaChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the spline range area data collection.</summary>
        public ObservableCollection<SplineRangeAreaModel> SplineRangeAreaData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="SplineRangeAreaChartViewModel"/> class.
        /// </summary>
        ...
        public void Dispose()
        {
           if(SplineRangeAreaData != null)
                SplineRangeAreaData.Clear();
        }
    }
}
