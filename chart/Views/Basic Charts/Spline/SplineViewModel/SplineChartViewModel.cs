...
{
    /// <summary>Provides datasets for default and dashed spline chart examples.</summary>
    public class SplineChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the default spline data.</summary>
        public ObservableCollection<SplineChartModel> SplineData { get; set; }

        /// <summary>Gets or sets the dashed spline data.</summary>
        public ObservableCollection<SplineChartModel> DashedSplineData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="SplineChartViewModel"/> class.
        /// </summary>
