...
{
    /// <summary>Provides Canada and Mexico datasets for step area charts.</summary>
    class StepAreaChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the Canada dataset.</summary>
        public ObservableCollection<StepAreaChartModel> CanadaData { get; set; }

        /// <summary>Gets or sets the Mexico dataset.</summary>
        public ObservableCollection<StepAreaChartModel> MexicoData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="StepAreaChartViewModel"/> class.
        /// </summary>
