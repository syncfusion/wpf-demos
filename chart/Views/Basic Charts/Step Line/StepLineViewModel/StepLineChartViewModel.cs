...
{
    /// <summary>Provides sample datasets for multiple step line chart scenarios.</summary>
    public class StepLineChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the default Canada dataset.</summary>
        public ObservableCollection<StepLineChartModel> CanadaData { get; set; }

        /// <summary>Gets or sets the default France dataset.</summary>
        public ObservableCollection<StepLineChartModel> FranceData { get; set; }

        /// <summary>Gets or sets Austria unemployment rates.</summary>
        public ObservableCollection<StepLineChartModel> AustriaUnemploymentData { get; set; }

        /// <summary>Gets or sets Canada unemployment rates.</summary>
        public ObservableCollection<StepLineChartModel> CanadaUnemploymentData { get; set; }

        /// <summary>Gets or sets the dataset for dashed step line comparison.</summary>
        public ObservableCollection<StepLineChartModel> DashedLinetData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="StepLineChartViewModel"/> class.
        /// </summary>
