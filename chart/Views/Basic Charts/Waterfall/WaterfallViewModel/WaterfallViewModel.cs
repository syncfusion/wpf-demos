...
{
    /// <summary>Provides data collections for waterfall chart demonstrations.</summary>
    public class WaterfallViewModel : IDisposable
    {
        /// <summary>Gets or sets the monthly revenue details.</summary>
        public ObservableCollection<WaterfallModel> RevenueDetails { get; set; }

        /// <summary>Gets or sets the sales breakdown used in the waterfall chart.</summary>
        public ObservableCollection<WaterfallModel> Sales { get; set; }

        /// <summary>Gets or sets the alternative sales dataset for comparison.</summary>
        public ObservableCollection<WaterfallModel> NewSales { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="WaterfallViewModel"/> class.
        /// </summary>
