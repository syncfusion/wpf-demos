...
{
    /// <summary>Provides time-series data and range for the trackball interaction demo.</summary>
    public class TrackballViewModel : IDisposable
    {
        /// <summary>Gets or sets the collection of sales data points.</summary>
        public ObservableCollection<TrackballModel> SalesData { get; set; }

        /// <summary>Gets or sets the minimum date displayed on the chart.</summary>
        public DateTime Minimum { get; set; }

        /// <summary>Gets or sets the maximum date displayed on the chart.</summary>
        public DateTime Maximum { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="TrackballViewModel"/> class.
        /// </summary>
