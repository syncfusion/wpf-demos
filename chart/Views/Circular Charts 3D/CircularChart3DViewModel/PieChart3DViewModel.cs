...
{
    /// <summary>Provides datasets and angle settings for 3D pie and doughnut charts.</summary>
    public class PieChart3DViewModel: NotificationObject , IDisposable
    {
        private double startAngle;
        private double endAngle;

        /// <summary>Gets or sets the start angle of the chart.</summary>
        ...
        /// <summary>Gets or sets the end angle of the chart.</summary>
        ...
        /// <summary>Gets or sets the default food distribution dataset.</summary>
        public ObservableCollection<PieChart3DModel> FoodData { get; set; }

        /// <summary>Gets or sets the crop distribution dataset.</summary>
        public ObservableCollection<PieChart3DModel> CropData { get; set; }

        /// <summary>Gets or sets the uranium production dataset.</summary>
        public ObservableCollection<PieChart3DModel> UraniumData { get; set; }

        /// <summary>Gets or sets the daily activity/hobbies dataset.</summary>
        public ObservableCollection<PieChart3DModel> HobbiesData { get; set; }

        /// <summary>Gets or sets the rice exporters dataset.</summary>
        public ObservableCollection<PieChart3DModel> RiceData { get; set; }

        /// <summary>Gets or sets the earth continents area dataset.</summary>
        public ObservableCollection<PieChart3DModel> EarthData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="PieChart3DViewModel"/> class.
        /// </summary>
