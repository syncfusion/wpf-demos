...
{
    /// <summary>Provides pie and doughnut datasets for grouping demonstrations.</summary>
    public class GroupingViewModel : IDisposable
    {
        /// <summary>Gets or sets the pie chart dataset.</summary>
        public IList<GroupingModel> PieData { get; set; }

        /// <summary>Gets or sets the doughnut chart dataset.</summary>
        public IList<GroupingModel> DoughnutData { get; set; }

        /// <summary>Gets the available pie grouping modes.</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupingViewModel"/> class.
        /// </summary>
