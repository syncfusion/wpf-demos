...
{
    /// <summary>Provides monthly rainfall data for MVVM binding demonstrations.</summary>
    public class MVVMBindingViewModel : IDisposable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MVVMBindingViewModel"/> class.
        /// </summary>
        ...
        /// <summary>Gets or sets the collection of rainfall records.</summary>
        ...
        public void Dispose()
        {
            if(RainfallDetails != null)
                RainfallDetails.Clear();
        }
    }
}
