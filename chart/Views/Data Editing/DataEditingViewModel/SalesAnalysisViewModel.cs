...
{
    /// <summary>Provides sales analysis data for editing demonstrations.</summary>
    public class SalesAnalysisViewModel : IDisposable
    {
        /// <summary>Gets or sets the collection of sales records.</summary>
        public ObservableCollection<SalesAnalysisModel> SalesData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="SalesAnalysisViewModel"/> class.
        /// </summary>
