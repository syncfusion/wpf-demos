...
{
    /// <summary>Represents medal counts per country index for fast stacking columns.</summary>
    public class FastStackingColumnChartMedal
    {
        /// <summary>Gets or sets the country identifier (index).</summary>
