...
{
    /// <summary>Generates and manages sample datasets for fast chart demonstrations.</summary>
    public class TestingValuesCollection : IDisposable
    {
        /// <summary>
		/// Initializes a new instance of the <see cref="TestingValuesCollection"/> class.
		/// </summary>
        ...
        /// <summary>Gets or sets the generated testing data points.</summary>
    ...
    /// <summary>Provides financial data for the series demos.</summary>
    public class FinancialViewModel : IDisposable
    {
        /// <summary>Gets or sets the financial data collection.</summary>
        public ObservableCollection<FinancialDataModel> FinancialData { get; set; }

        /// <summary>
		/// Initializes a new instance of the <see cref="FinancialViewModel"/> class.
		/// </summary>
