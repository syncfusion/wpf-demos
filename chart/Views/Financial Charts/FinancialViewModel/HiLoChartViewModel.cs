...
{
    /// <summary>Provides sample high/low data for HiLo chart demonstrations.</summary>
    public class HiLoChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the HiLo data collection.</summary>
        public ObservableCollection<HiLoChartModel> HiloData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="HiLoChartViewModel"/> class.
        /// </summary>
