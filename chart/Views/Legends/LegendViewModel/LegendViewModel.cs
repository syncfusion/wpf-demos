...
{
    /// <summary>Provides multiple datasets for legend customization and interaction demos.</summary>
    public class LegendViewModel : ObservableCollection<LegendModel>, IDisposable
    {
        /// <summary>Gets or sets the first customized legend dataset.</summary>
        public IList<LegendModel> LegendData1 { get; set; }

        /// <summary>Gets or sets the second customized legend dataset.</summary>
        public IList<LegendModel> LegendData2 { get; set; }

        /// <summary>Gets or sets the third customized legend dataset.</summary>
        public IList<LegendModel> LegendData3 { get; set; }

        /// <summary>Gets or sets the fourth customized legend dataset.</summary>
        public IList<LegendModel> LegendData4 { get; set; }

        /// <summary>Gets or sets the dataset used for toggling legend items.</summary>
        public IList<LegendModel> ToggledLegendData { get; set; }

        /// <summary>Gets or sets the dataset used for multiple legends (sales/target).</summary>
        public ObservableCollection<LegendModel> Data { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="LegendViewModel"/> class.
        /// </summary>
        ...
        /// <summary>Clears datasets and releases resources.</summary>
        public void Dispose()
        {
            if (LegendData1 != null)
                LegendData1.Clear();
