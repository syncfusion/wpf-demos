...
{
    /// <summary>Provides climate data used to demonstrate strip lines.</summary>
    public class StripLinesViewModel : IDisposable
    {
        /// <summary>Gets or sets the monthly climate data.</summary>
        public ObservableCollection<StripLinesModel> ClimateData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="StripLinesViewModel"/> class.
        /// </summary>
