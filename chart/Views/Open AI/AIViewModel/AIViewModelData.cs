...
{
    /// <summary>Provides raw and AI‑cleaned datasets with busy state for the preprocessing demo.</summary>
    public class AIViewModelData : NotificationObject, IDisposable
    {
        /// <summary>Gets or sets the original data (may include missing/outlier values).</summary>
        public ObservableCollection<AIModel> RawData { get; set; }

        private ObservableCollection<AIModel> cleanData;

        /// <summary>Gets or sets the cleaned data returned by the AI service.</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AIViewModelData"/> class.
        /// </summary>
