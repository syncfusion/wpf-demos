...
{
    /// <summary>Calls an AI endpoint to clean and impute time-series data.</summary>
    public class PreprocessingAzureAIService
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreprocessingAzureAIService"/> class.
        /// </summary>
        ...
        /// <summary>Sends the raw data to the AI service and returns the cleaned collection.</summary>
        ...
        /// <summary>Parses cleaned text lines into AIModel items.</summary>
