...
{
    /// <summary>Provides datasets for polar and radar chart demonstrations.</summary>
    public class PolarChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the polar chart dataset (year vs. products).</summary>
        public ObservableCollection<PolarChartModel> PolarData { get; set; }

        /// <summary>Gets or sets the radar chart dataset (direction vs. species values).</summary>
        public ObservableCollection<PolarChartModel> RadarData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="PolarChartViewModel"/> class.
        /// </summary>
