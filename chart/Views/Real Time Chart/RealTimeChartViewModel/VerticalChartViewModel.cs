...
{
    /// <summary>Streams time-based velocity data for a vertical real-time chart.</summary>
    public class VerticalChartViewModel : ObservableCollection<VerticalChartModel>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="VerticalChartViewModel"/> class.
        /// </summary>
        ...
        /// <summary>Stops timers and releases resources.</summary>
        public void Dispose()
        {
            if (timer != null)
            {
