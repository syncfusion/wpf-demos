...
{
    /// <summary>Provides emission data for 100% stacked area charts.</summary>
    public class StackedArea100ViewModel : IDisposable
    {
        /// <summary>Gets or sets the emission dataset.</summary>
        public ObservableCollection<StackedArea100Model> EmissionData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="StackedArea100ViewModel"/> class.
        /// </summary>
