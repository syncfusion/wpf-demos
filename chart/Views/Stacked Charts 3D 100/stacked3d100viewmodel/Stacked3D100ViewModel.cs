...
{
    /// <summary>Provides datasets for 3D 100% stacked column and bar chart demonstrations.</summary>
    public class Stacked3D100ViewModel : IDisposable
    {
        /// <summary>Gets or sets cloud-region market share data.</summary>
        public ObservableCollection<Stacked3D100Model> CloudData { get; set; }

        /// <summary>Gets or sets Sahara-region water access shares.</summary>
        public ObservableCollection<Stacked3D100Model> SaharaData { get; set; }

        /// <summary>Gets or sets low‑income water access shares.</summary>
        public ObservableCollection<Stacked3D100Model> LowIncomeData { get; set; }

        /// <summary>Gets or sets pet acquisition source shares.</summary>
        public ObservableCollection<Stacked3D100Model> PetData { get; set; }

        /// <summary>Gets or sets the first cost dataset (Q1–Q4).</summary>
        public ObservableCollection<Stacked3D100Model> CostData { get; set; }

        /// <summary>Gets or sets the second cost dataset (Q1–Q4).</summary>
        public ObservableCollection<Stacked3D100Model> CostData1 { get; set; }

        /// <summary>Gets or sets the third cost dataset (Q1–Q4).</summary>
        public ObservableCollection<Stacked3D100Model> CostData2 { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="Stacked3D100ViewModel"/> class.
        /// </summary>
        ...
        /// <summary>Releases resources and clears data collections.</summary>
        public void Dispose()
        {
            if (CloudData != null)
                CloudData.Clear();
