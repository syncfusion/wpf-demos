...
{
    /// <summary>Provides datasets for 3D stacked column, clustered stacked column, stacked bar, and clustered stacked bar charts.</summary>
    public class StackedChart3DViewModel : IDisposable
    {
        /// <summary>Gets or sets the stacked column dataset for patents.</summary>
        public ObservableCollection<StackedChart3DModel> PatentsData { get; set; }

        /// <summary>Gets or sets the clustered stacked column quarterly dataset.</summary>
        public ObservableCollection<StackedChart3DModel> AnnualDetails { get; set; }

        /// <summary>Gets or sets the stacked bar product metrics dataset.</summary>
        public ObservableCollection<StackedChart3DModel> ProductData { get; set; }

        /// <summary>Gets or sets the first regional group dataset for clustered stacked bars.</summary>
        public ObservableCollection<StackedChart3DModel> Group1 { get; set; }

        /// <summary>Gets or sets the second regional group dataset for clustered stacked bars.</summary>
        public ObservableCollection<StackedChart3DModel> Group2 { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="StackedChart3DViewModel"/> class.
        /// </summary>
