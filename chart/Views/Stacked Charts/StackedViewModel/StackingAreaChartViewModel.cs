...
{
    /// <summary>Provides sample sales data for stacked area charts.</summary>
    public class StackingAreaChartViewModel : IDisposable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StackingAreaChartViewModel"/> class.
        /// </summary>
        ...
        /// <summary>Gets or sets the stacked area sales dataset.</summary>
