...
{
    /// <summary>Provides stacked line chart sample data.</summary>
    public class StackingLineChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the annual GDP growth data by country.</summary>
        public ObservableCollection<StackingLineChartModel> StackedLinedData { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="StackingLineChartViewModel"/> class.
        /// </summary>
