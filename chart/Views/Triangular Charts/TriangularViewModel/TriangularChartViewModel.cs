...
{
    /// <summary>Provides data and configuration for pyramid and funnel chart demos.</summary>
    public class TriangularChartViewModel : IDisposable
    {
        /// <summary>Gets or sets the default pyramid chart data.</summary>
        public IList<TriangularChartModel> PyramidData { get; set; }

        /// <summary>Gets or sets the customized pyramid chart data.</summary>
        public IList<TriangularChartModel> CustomizedPyramidData { get; set; }

        /// <summary>Gets or sets the default funnel chart data.</summary>
        public IList<TriangularChartModel> FunnelData { get; set; }

        /// <summary>Gets or sets the customized funnel chart data.</summary>
        public IList<TriangularChartModel> CustomizedFunnelData { get; set; }

        /// <summary>Gets the available funnel layout modes.</summary>
        public Array FunnelMode
        {
            get { return Enum.GetValues(typeof(ChartFunnelMode)); }
        }

        /// <summary>Gets the available pyramid layout modes.</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TriangularChartViewModel"/> class.
        /// </summary>
        ...
        /// <summary>Clears data collections and releases resources.</summary>
        public void Dispose()
        {
            if (PyramidData != null)
                PyramidData.Clear();
