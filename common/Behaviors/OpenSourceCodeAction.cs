...
namespace syncfusion.demoscommon.wpf
{
    ...
    public class OpenSourceCodeAction : TriggerAction<Button>
    {
        ...
        /// <summary>
        /// Opens Visual studio solution for the specified Olap products.
        /// </summary>
        /// <param name="selectedProduct">The name of the Selected product demo.</param>
        ...
        private void OpenSourceCode(Assembly assembly, string buttonName)
        {
            ...
            string root = "";
            string targetFilePath = Path.GetFullPath(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, @"..\\..\\targets\\MultiTargeting.targets"));
