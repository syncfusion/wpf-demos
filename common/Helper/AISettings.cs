...
namespace syncfusion.demoscommon.wpf
{
    ...
    {
        static string modelName = Properties.Settings.Default.ModelName;
        static string key = Properties.Settings.Default.Key;
        static string endPoint = Properties.Settings.Default.EndPoint;
