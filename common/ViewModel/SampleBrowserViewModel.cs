...
        private Visibility blurVisibility = Visibility.Collapsed;
        ...
        private void OnClicked(object paramater)
        {
            ...
            {
#if WORDSDK
                System.Diagnostics.Process.Start(new ProcessStartInfo("https://help.syncfusion.com/document-processing/word/overview") { UseShellExecute = true });
#elif PDFSDK
                System.Diagnostics.Process.Start(new ProcessStartInfo("https://help.syncfusion.com/document-processing/pdf/overview") { UseShellExecute = true });
#else
