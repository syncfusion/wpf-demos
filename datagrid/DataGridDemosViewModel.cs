...
namespace syncfusion.datagriddemos.wpf
{
    ...
    public class DataGridProductDemos : ProductDemo
    {
        public DataGridProductDemos()
        {
            ...
            intervalGroupingDocumentation.Add(new Documentation { Content = "DataGrid - GroupColumnDescription_Converter API Reference", Uri = new Uri("https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.Grid.GroupColumnDescription.html#Syncfusion_UI_Xaml_Grid_GroupColumnDescription_Converter") });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Row Selection", GroupName = "SELECTIONS", Tag = Tag.Updated, Description = "This sample showcases the row selection capability of SfDataGrid. SfDataGrid control provides an interactive support for selecting rows in different mode with smooth and ease manner. SfDataGrid allows you to select more than one row at a time by using SelectionMode property of SfDataGrid. This property provides options like Single, SingleDeselect, Multiple, Extended and None.", DemoViewType = typeof(SelectionDemo), Documentations = rowSelectionDocumentation });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Cell Selection", GroupName = "SELECTIONS", Tag = Tag.Updated, Description = "This sample showcases the cell selection capability of SfDataGrid. SfDataGrid control provides an interactive support for selecting cells in different mode with smooth and ease manner by SelectionUnit as Cell or Any and NavigationMode should be Cell. SfDataGrid allows you to select more than one cell at a time by using SelectionMode property of SfDataGrid. This property provides options like Single, SingleDeselect, Multiple, Extended and None.", DemoViewType = typeof(CellSelectionDemo),Documentations = cellSelectionDocumentation });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "CheckBox Selector Column", GroupName = "SELECTIONS", Tag = Tag.Updated, Description = "This sample showcases the DataGrid with a grid check-box-selector column. It displays check boxes for all the rows to allow users to select or deselect them by clicking on them.", DemoViewType = typeof(CheckBoxSelectorColumnDemo), Documentations = checkboxSelectoColumnDocumentation });

            List<Documentation> excelStyleSelectionDocumentation = new List<Documentation>();
            excelStyleSelectionDocumentation.Add(new Documentation { Content = "DataGrid - Cell Selection Documentation", Uri = new Uri("https://help.syncfusion.com/wpf/datagrid/selection#cell-selection") });
            excelStyleSelectionDocumentation.Add(new Documentation { Content = "DataGrid - GridSelectionUnit API Reference", Uri = new Uri("https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.Grid.GridSelectionUnit.html") });
            excelStyleSelectionDocumentation.Add(new Documentation { Content = "DataGrid - GridSelectionMode API Reference", Uri = new Uri("https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.Grid.GridSelectionMode.html") });
            this.Demos.Add(new DemoInfo() { SampleName = "Excel-Style Selection", Tag = Tag.New, GroupName = "SELECTIONS", Description = "This sample showcases the Excel-style selection capability of SfDataGrid. Selecting a cell highlights its row and column headers, like Excel. Clicking a column header selects the entire column and highlights its header; clicking a row header selects the entire row and highlights its header. During drag or Shift selection, a common border outlines the entire selected range.", DemoViewType = typeof(ExcelStyleSelectionDemo), Documentations = excelStyleSelectionDocumentation });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Clipboard Operation", GroupName = "INTERACTIVE FEATURES", Tag = Tag.Updated, Description = "This sample showcases the clipboard operation capabilities of SfDataGrid. The SfDataGrid, provides an interactive support to perform cut, copy and paste operations by using GridCopyOption and GridPasteOption properties. The GridCopyOption provides options like None, CopyData, CutData, IncludeHeaders, and IncludeFormat and the GridPasteOption provides options like None, PasteData, IncludeFirstLine.", DemoViewType = typeof(CutCopyPasteDemo), Documentations = clipBoardOperationDocumentation });
