...
namespace syncfusion.datagriddemos.wpf
{
    ...
    public class DataGridProductDemos : ProductDemo
    {
        public DataGridProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Excel-Style Selection",  GroupName = "SELECTIONS", Description = "This sample showcases the Excel-style selection capability of SfDataGrid. Selecting a cell highlights its row and column headers, like Excel. Clicking a column header selects the entire column and highlights its header; clicking a row header selects the entire row and highlights its header. During drag or Shift selection, a common border outlines the entire selected range.", DemoViewType = typeof(ExcelStyleSelectionDemo), Documentations = excelStyleSelectionDocumentation });
