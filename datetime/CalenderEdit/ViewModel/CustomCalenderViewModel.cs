...
namespace syncfusion.datetimedemos.wpf
{
	public class CustomCalenderViewModel
    {
		...
		{
			ResourceDictionary resourceDictionary = new ResourceDictionary() { Source = new Uri("/syncfusion.datetimedemos.wpf;component/Assets/CalenderEdit/CalendarEditTemplate.xaml", UriKind.RelativeOrAbsolute) };
