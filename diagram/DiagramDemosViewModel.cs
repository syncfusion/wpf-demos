...
namespace syncfusion.diagramdemo.wpf
{
    ...
    public class DiagramProductDemos : ProductDemo
    {
        public DiagramProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Fishbone Diagram", GroupName = "Real-time diagrams", Description = "This is a sample of a simple fishbone diagram. Diagram nodes and annotations are used to define fishbone diagrams.", DemoViewType = typeof(Views.FishboneDiagram) , Tag = Tag.New });
