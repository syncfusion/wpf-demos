...
namespace syncfusion.diagramdemo.wpf
{
    ...
    public class DiagramProductDemos : ProductDemo
    {
        public DiagramProductDemos()
        {
            ...
            List<Documentation> ForceDirectedTreeHelpDocuments = new List<Documentation>()
             {
               new Documentation(){ Content = "Diagram - Force Directed Tree", Uri = new Uri("https://help.syncfusion.com/wpf/diagram/automatic-layouts/automatic-layouts")},
             };
            this.Demos.Add(new DemoInfo() { SampleName = "Force Directed Tree", Tag = Tag.None, GroupName = "Automatic Layout", Description = "This sample demonstrates Force Directed Tree Layout of Diagram.", DemoViewType = typeof(Views.ForceDirectedTree), Documentations = ForceDirectedTreeHelpDocuments });
            ...
            List<Documentation> VennDiagramHelpDocuments = new List<Documentation>()
             {
                new Documentation(){ Content = "Diagram - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/diagram/getting-started")},
             };
            this.Demos.Add(new DemoInfo() { SampleName = "Venn Diagram", GroupName = "Real-time diagrams", Description = "This example visualize data science classifications through Venn Diagram using Nodes and Connectors", DemoViewType = typeof(Views.VennDiagram), Tag = Tag.New, Documentations = VennDiagramHelpDocuments });


            List<Documentation> TicketBookingSystemHelpDocuments = new List<Documentation>()
             {
                new Documentation(){ Content = "Diagram - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/diagram/getting-started")},
             };
            this.Demos.Add(new DemoInfo() { SampleName = "Ticket Booking System", GroupName = "Use Case Diagrams", Description = "This sample implements a functional movie ticket booking interface using the WPF Diagram component, providing an intuitive visual representation of a cinema hall's seating arrangement with real-time price updates and a complete booking workflow. In this Diagram, nodes are used to define the ticket booking system.", DemoViewType = typeof(Views.TicketBookingSystem), Tag = Tag.New, Documentations = TicketBookingSystemHelpDocuments });

            List<Documentation> FunnelDiagramHelpDocuments = new List<Documentation>()
             {
                new Documentation(){ Content = "Diagram - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/diagram/getting-started")},
             };
            this.Demos.Add(new DemoInfo() { SampleName = "Funnel Diagram", GroupName = "Use Case Diagrams", Description = "The funnel diagram is built using the WPF Diagram, and it visually represents the conversion flow of users through a marketing campaign. The diagram is structured as a vertically stacked funnel, narrowing from top to bottom to indicate decreasing user counts at each stage of the customer journey. ", DemoViewType = typeof(Views.FunnelDiagram), Tag = Tag.New, Documentations = FunnelDiagramHelpDocuments });

            List<Documentation> ShortestPathHelpDocuments = new List<Documentation>()
             {
                new Documentation(){ Content = "Diagram - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/diagram/getting-started")},
             };
            this.Demos.Add(new DemoInfo() { SampleName = "Shortest Path Visualizer", GroupName = "Use Case Diagrams", Description = "This sample demonstrates an interactive shortest path algorithm visualization using the WPF Diagram component, featuring a dynamic graph where users select source and destination nodes to view animated optimal paths.", DemoViewType = typeof(Views.ShortestPathVisualizer), Tag = Tag.New, Documentations = ShortestPathHelpDocuments });

            List<Documentation> PeriodicTableHelpDocuments = new List<Documentation>()
             {
                new Documentation(){ Content = "Diagram - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/diagram/getting-started")},
             };
            this.Demos.Add(new DemoInfo() { SampleName = "Periodic Table", GroupName = "Use Case Diagrams", Description = "This sample demonstrates an interactive Periodic Table of Elements built using the WPF Diagram component, displaying all known elements with categorization by color, detailed hover information, and highlighting by period or group.", DemoViewType = typeof(Views.PeriodicTable), Tag = Tag.New, Documentations = PeriodicTableHelpDocuments });

            List<Documentation> NeuralNetworkHelpDocuments = new List<Documentation>()
             {
                new Documentation(){ Content = "Diagram - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/diagram/getting-started")},
             };
            this.Demos.Add(new DemoInfo() { SampleName = "Neural Network Diagram", GroupName = "Real-time diagrams", Description = "This sample provides an interactive visualization of a neural network's architecture using the WPF Diagram component. It displays multi-layered networks with configurable neurons, connections, and weight annotations.", DemoViewType = typeof(Views.NeuralNetworkDiagram), Tag = Tag.New, Documentations = NeuralNetworkHelpDocuments });

            List<Documentation> HistoryTimelineHelpDocuments = new List<Documentation>()
             {
                new Documentation(){ Content = "Diagram - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/diagram/getting-started")},
             };
            this.Demos.Add(new DemoInfo() { SampleName = "History Timeline", GroupName = "Use Case Diagrams", Description = "This sample visualizes key milestones in Internet history using the interactive WPF Diagram (SfDiagram) component. Events are presented as nodes on a horizontal timeline with color-coded sections, year markers, and customizable event details.", DemoViewType = typeof(Views.History_Timeline), Tag = Tag.New, Documentations = HistoryTimelineHelpDocuments });
