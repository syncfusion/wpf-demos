...
namespace syncfusion.diagramdemo.wpf
{
    ...
    public class DiagramProductDemos : ProductDemo
    {
        public DiagramProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Line Routing", Tag = Tag.New, GroupName = "Getting Started", Description = "This sample visualizes the connectors that are automatically re-routing or moving away if any shape found on the connectors path and Bridging feature of the connectors.", DemoViewType = typeof(Views.LineRouting) });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "History Manager", Tag = Tag.New, GroupName = "Getting Started", Description = "This sample demonstrates viewing, deleting, limiting diagram history and groups diagram actions and stores it as a single entry in the history manager.", DemoViewType = typeof(Views.HistoryManager) });
