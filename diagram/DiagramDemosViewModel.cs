...
namespace syncfusion.diagramdemo.wpf
{
    ...
    public class DiagramProductDemos : ProductDemo
    {
        public DiagramProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Force Directed Tree", Tag = Tag.New, GroupName = "Automatic Layout", Description = "This sample demonstrates Force Directed Tree Layout of Diagram.", DemoViewType = typeof(Views.ForceDirectedTree), Documentations = ForceDirectedTreeHelpDocuments });
