...
namespace syncfusion.diagramdemo.wpf
{
    ...
    public class DiagramProductDemos : ProductDemo
    {
        public DiagramProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Sequence Diagram", Tag = Tag.Updated, GroupName = "UML Diagrams", Description = "This sample illustrates how to create a sequence diagram using UMLSequenceDiagramModel", DemoViewType = typeof(Views.SequenceDiagram), Documentations = SequenceDiagramHelpDocuments });
