...
namespace syncfusion.diagramdemo.wpf
{
    ...
    public class DiagramProductDemos : ProductDemo
    {
        public DiagramProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Commands", GroupName = "Getting Started", Description = "This sample demonstrates the various types of Commands supported in SfDiagram.", DemoViewType = typeof(Views.Commands) , Documentations = CommandsHelpDocuments, Tag = Tag.Updated });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Organization Chart", GroupName = "Automatic Layout", Description = "This sample demonstrates Organization Layout of Diagram.", DemoViewType = typeof(Views.OrganizationLayout) , Documentations = OrganizationChartHelpDocuments });
             ...
             {
                new Documentation(){ Content = "Diagram - Mindmap Layout", Uri = new Uri("https://help.syncfusion.com/wpf/diagram/automatic-layouts/mindmaptreelayout")},
             }; 
            this.Demos.Add(new DemoInfo() { SampleName = "Mindmap Layout", GroupName = "Automatic Layout", Description = "This sample demonstrates MindMapLayout of Diagram.", DemoViewType = typeof(Views.MindMap) , Documentations = MindmapLayoutHelpDocuments });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Activity Diagram", GroupName = "UML Diagrams", Description = "This sample represents the message flow from one activity to another in customer service using built-in UML Activity diagram shapes.", DemoViewType = typeof(Views.ActivityDiagram), Tag = Tag.New, Documentations = ActivityHelpDocument });
            List<Documentation> UseCaseHelpDocument = new List<Documentation>()
            {
                new Documentation() { Content = "Diagram - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/diagram/getting-started") },
            };
            this.Demos.Add(new DemoInfo() { SampleName = "Use Case Diagram", GroupName = "UML Diagrams", Description = "This sample represents the online shopping of a web customer using built-in UML Use Case diagram shapes.", DemoViewType = typeof(Views.UseCaseDiagram), Tag = Tag.New, Documentations = UseCaseHelpDocument });
            List<Documentation> StateDiagramHelpDocument = new List<Documentation>()
            {
                new Documentation() { Content = "Diagram - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/diagram/getting-started") },
            };
            this.Demos.Add(new DemoInfo() { SampleName = "State Diagram", GroupName = "UML Diagrams", Description = "This sample represents the Bank ATM process using built-in UML State diagram shapes.", DemoViewType = typeof(Views.StateDiagram), Tag = Tag.New, Documentations = StateDiagramHelpDocument });
           ...
           this.Demos.Add(new DemoInfo() { SampleName = "Sequence Diagram", GroupName = "Real-time diagrams", Description = "This sample illustrates how to create sequence diagram using Port feature for Node.", DemoViewType = typeof(Views.SequenceDiagram) , Documentations = SequenceDiagramHelpDocuments});
