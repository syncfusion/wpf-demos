...
namespace syncfusion.diagramdemo.wpf
{
    ...
    public class DiagramProductDemos : ProductDemo
    {
        public DiagramProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Containers", Tag = Tag.New, GroupName = "Getting Started", Description = "This example shows how to visualize the Azure Container Apps environment with the help of built-in SfDiagram Container support.", DemoViewType = typeof(Views.Container) });
