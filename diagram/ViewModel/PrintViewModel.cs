            ...
            switch (content)
            {
                ...
                case "Custom Margins":
                    if (!CustomMarginChanged)
                    {
                        ...
                        custom.ShowDialog();
                        if (custom.PrintMarginLeftUPDowm.Value != null && custom.PrintMarginRightUPDowm.Value != null &&
                            custom.PrintMarginBottomUPDowm.Value != null && custom.PrintMarginTopUPDowm.Value != null)
                        {
                            PageSettings.PrintMargin = new Thickness((double)custom.PrintMarginLeftUPDowm.Value,
                                                                     (double)custom.PrintMarginTopUPDowm.Value,
                                                                     (double)custom.PrintMarginRightUPDowm.Value,
                                                                     (double)custom.PrintMarginBottomUPDowm.Value);
