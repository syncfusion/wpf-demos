    ...
    public class DockingManagerProductDemos : ProductDemo
    {
        public DockingManagerProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", Description= "This sample showcases the DockingManager control with basic functionalities.",
                GroupName = "Docking Manager", DemoViewType = typeof(GettingStarted) });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Maximization", Description = "This sample exhibits support for minimize and maximize the dock windows as well as maximize mode.", GroupName = "Docking Manager", DemoViewType = typeof(DockChildMaximization) });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Floating Windows", Description = "This sample showcases the docking manager layout with the Floating windows and its alignment functionalities", GroupName = "Docking Manager", DemoViewType = typeof(FloatWindow) });
            this.Demos.Add(new DemoInfo() { SampleName = "Tabbed Windows", Description = "This sample showcases the docking manager layout with the tabbed windows and its alignment functionalities", GroupName = "Docking Manager", DemoViewType = typeof(TabbedWindow) });
            this.Demos.Add(new DemoInfo() { SampleName = "Multiple Document Interface", Description= "This sample showcases the MDI layout of the Document Window and different types of navigations when pressing Ctrl + Tab key.", GroupName = "Docking Manager", DemoViewType = typeof(MDIDemo) });
            this.Demos.Add(new DemoInfo() { SampleName = "Tabbed Document Interface", Description= "This sample showcases the TDI layout of the Document Window and different types of navigations when pressing Ctrl + Tab key.", GroupName = "Docking Manager", DemoViewType = typeof(TDIDemo) });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Visual Studio like State Persistence", Description= "This sample showcases how the docking manager retains the different mode layouts when the application is closed and reopened like Visual Studio.", GroupName = "Docking Manager", DemoViewType = typeof(DockingManagerlikeVisualStudio) });
