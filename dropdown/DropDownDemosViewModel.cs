...
namespace syncfusion.dropdowndemos.wpf
{
    ...
    public class MultiColumnDropDownProductDemos : ProductDemo
    {
        public MultiColumnDropDownProductDemos()
        {
            ...
            List<Documentation> multiColumnDropDownDocumentation = new List<Documentation>();
            multiColumnDropDownDocumentation.Add(new Documentation { Content = "MultiColumn DropDown - API Reference", Uri = new Uri("https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.Grid.SfMultiColumnDropDownControl.html") });
            multiColumnDropDownDocumentation.Add(new Documentation { Content = "MultiColumn DropDown - Getting Started Documentation", Uri = new Uri("https://help.syncfusion.com/wpf/multi-column-dropdown/getting-started") });
            this.Demos.Add(new DemoInfo() { SampleName = "MultiColumn Dropdown", Description = "This sample showcases the features in SfMultiColumnDropDownControl. SfMultiColumnDropDownControl is a selection control with drop down SfDataGrid that can be shown or hidden by clicking the arrow control. It provides textbox to the user. Based on the user input, it shows the possible suggestion to the users. The SfMultiColumnDropDownControl provides features like AllowAutoComplete, AllowIncrementalFiltering, AllowCaseSensitiveFiltering, AllowImmediatePopup and ReadOnly.", GroupName = "MULTICOLUMN DROPDOWN", DemoViewType = typeof(MultiColumnDropDownDemo), ThemeMode = ThemeMode.Inherit, Documentations = multiColumnDropDownDocumentation });
    ...
    public class AutoCompleteProductDemos : ProductDemo
    {
        ...
        public AutoCompleteProductDemos()
        {
            ...
            DemoInfo AutoCompleteDemoInfo = new DemoInfo()
            {
                SampleName = "AutoComplete", GroupName = "Auto Complete", Description = "This sample showcases the capabilities of AutoComplete (SfTextBoxExt) like different suggestion modes, watermark texts, setting minimum prefix characters, and custom filters.", DemoViewType = typeof(AutoCompleteDemo), ThemeMode = ThemeMode.Inherit
            };
            List<Documentation> AutoCompleteDocuments = new List<Documentation>()
            {
                new Documentation(){ Content="AutoComplete(SfTextBoxExt)", Uri = new Uri("https://help.syncfusion.com/wpf/autocomplete/autocomplete-and-filtering")},
            };
            AutoCompleteDemoInfo.Documentations = AutoCompleteDocuments;
            this.Demos.Add(AutoCompleteDemoInfo);
            
            DemoInfo AutoCompleteMultiSelection = new DemoInfo()
            {
                SampleName = "MultiSelection", GroupName = "Auto Complete", Description = "This sample showcases the multiple selection support in AutoComplete (SfTextBoxExt).", DemoViewType = typeof(MultiSelectionDemo), ThemeMode = ThemeMode.Inherit
            };
            List<Documentation> MultiSelectionDocuments = new List<Documentation>()
            {
                new Documentation(){ Content="MultiSelection", Uri = new Uri("https://help.syncfusion.com/wpf/autocomplete/single-and-multiple-selection#multi-selection")},
            };
            AutoCompleteMultiSelection.Documentations = MultiSelectionDocuments;
            this.Demos.Add(AutoCompleteMultiSelection);
    ...
    public class TextboxExtProductDemos : ProductDemo
    {
        ...
        public TextboxExtProductDemos()
        {
            ...
            DemoInfo TextboxExtDemo = new DemoInfo()
            {
                SampleName = "AutoComplete", GroupName = "TextboxExt", Description = "This sample showcases the capabilities of AutoComplete (TextBoxExt) like different suggestion modes, watermark texts, setting minimum prefix characters, and custom filters.", DemoViewType = typeof(AutoCompleteDemo), ThemeMode = ThemeMode.Inherit
            };
            List<Documentation> TextboxExtDocuments = new List<Documentation>()
            {
                new Documentation(){ Content="TextBoxExt", Uri = new Uri("https://help.syncfusion.com/wpf/autocomplete/autocomplete-and-filtering")},
            };
            TextboxExtDemo.Documentations = TextboxExtDocuments;
            this.Demos.Add(TextboxExtDemo);
            
            DemoInfo MultiSelectionDemoInfo = new DemoInfo()
            {
                SampleName = "MultiSelection", GroupName = "TextboxExt", Description = "This sample showcases the multiple selection support in AutoComplete (TextBoxExt).", DemoViewType = typeof(MultiSelectionDemo), ThemeMode = ThemeMode.Inherit
            };
            List<Documentation> MultiSelectionDocuments = new List<Documentation>()
            {
                new Documentation(){ Content="MultiSelection", Uri = new Uri("https://help.syncfusion.com/wpf/autocomplete/single-and-multiple-selection#multi-selection")},
            };
            MultiSelectionDemoInfo.Documentations = MultiSelectionDocuments;
            this.Demos.Add(MultiSelectionDemoInfo);
        }
    }
}