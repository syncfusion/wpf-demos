...
namespace syncfusion.dropdowndemos.wpf
{
    ...
    public class ComboBoxProductDemos : ProductDemo
    {
        ...
        public ComboBoxProductDemos()
        {
            ...
            this.ProductCategory = "LISTS AND DROPDOWN";
            this.Demos = new List<DemoInfo>();
            this.Demos.Add(new DemoInfo() { SampleName = "ComboBox", Description = "This sample showcases the various features of ComboBox control such as single selection, multi-selection, delimiter character and watermark support.", Tag = Tag.Updated, GroupName = "ComboBox", DemoViewType = typeof(ComboBoxView) });
            this.Demos.Add(new DemoInfo() { SampleName = "Editing", Description = "This sample showcases the various autocomplete modes of ComboBox.",Tag = Tag.New, GroupName = "ComboBox", DemoViewType = typeof(AutoComplete) });
        }
    }
    ...
    public class AutoCompleteProductDemos : ProductDemo
    {
        ...
        public AutoCompleteProductDemos()
        {
            ...
            this.Tag = Tag.Updated;
            this.Demos = new List<DemoInfo>();
            this.Demos.Add(new DemoInfo() { SampleName = "AutoComplete", Description = "This sample showcases the capabilities of AutoComplete (SfTextBoxExt) like different suggestion modes, watermark texts, setting minimum prefix characters, and custom filters.", GroupName = "Auto Complete", Tag = Tag.Updated, DemoViewType = typeof(AutoCompleteDemo), ThemeMode = ThemeMode.Inherit });
