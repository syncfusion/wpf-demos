...
namespace syncfusion.dropdowndemos.wpf
{
    ...
    public class ComboBoxProductDemos : ProductDemo
    {
        ...
        public ComboBoxProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "SmartComboBox", Description = "This sample demonstrates smart filtering in ComboBox for fast and efficient item search.", GroupName = "ComboBox", DemoViewType = typeof(SmartComboBox), Tag = Tag.New });
        }
    }
