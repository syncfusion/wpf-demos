...
namespace syncfusion.editordemos.wpf
{
    ...
    public class RangeSliderProductDemos : ProductDemo
    {
        public RangeSliderProductDemos()
        {
            ...
            {
                SampleName = "Customization", GroupName = "Range Slider", Description = "This sample showcases the different customizations that can be done for the track, thumb, and tooltip of Range Slider.", DemoViewType = typeof(Customization), ThemeMode = ThemeMode.None, Tag = Tag.None
            };
