...
namespace syncfusion.ganttdemos.wpf
{
    ...
    public class GanttProductDemos : ProductDemo
    {
        public GanttProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Resource View Gantt", GroupName = "DATA BINDING", Description= "The Gantt control allows you to populate multiple nodes in a single row by using inline task mapping. This sample showcases how to build a resource view Gantt using inline task mapping. It will reflect the work progress of the resources involved in a small control-development process. It also includes virtualization support, ensuring smooth scrolling and optimal performance even with large data sets.", Tag = Tag.Updated, DemoViewType = typeof(ResourceView) });
