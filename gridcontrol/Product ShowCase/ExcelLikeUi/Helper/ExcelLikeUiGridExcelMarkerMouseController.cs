...
namespace syncfusion.gridcontroldemos.wpf
{
    ...
    class ExcelLikeUiGridExcelMarkerMouseController : IMouseController, IDisposable
    {
        ...
        public ExcelLikeUiGridExcelMarkerMouseController(GridControlBase grid)
        {
            ...
            this.ExcelRangeExtended += new ExcelRangeExtendedEventHandler(ExcelLikeUiGridExcelMarkerMouseController_ExcelRangeExtended);
        }

        void ExcelLikeUiGridExcelMarkerMouseController_ExcelRangeExtended(object sender, ExcelRangeExtendedEventArgs e)
        {
