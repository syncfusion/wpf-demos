...
namespace syncfusion.imageeditordemos.wpf
{
    ...
    public class ImageEditorProductDemos : ProductDemo
    {
        public ImageEditorProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", GroupName = "IMAGE EDITOR", DemoViewType = typeof(GettingStarted), Description = "This sample demonstrates the basic features in SfImageEditor.", Tag = Tag.Updated });
