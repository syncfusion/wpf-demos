...
namespace syncfusion.kanbandemos.wpf
{
    ...
    public class KanbanProductDemos : ProductDemo
    {
        public KanbanProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Customization", GroupName = "KANBAN BOARD", Description = "This sample demonstrates the kanban view customization using DataTemplates.", DemoViewType = typeof(Customization), Tag = Tag.Updated });
