...
namespace syncfusion.layoutdemos.wpf
{
    ...
    public class TextInputLayoutProductDemos : ProductDemo
    {
        ...
        public TextInputLayoutProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Smart Paste", IsAISample = true, Description = "AI-Powered smart paste in TextInputLayout control maps clipboard data for efficient form completion.", GroupName = "SMART FORM FILLING", DemoViewType = typeof(FeedbackFormSmartFill) });
        }
    }
