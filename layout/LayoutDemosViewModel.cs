...
namespace syncfusion.layoutdemos.wpf
{
    ...
    public class TextInputLayoutProductDemos : ProductDemo
    {
        ...
        public TextInputLayoutProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Smart Paste", Tag = Tag.New, IsAISample = true, Description = "AI-Powered smart paste in TextInputLayout control maps clipboard data for efficient form completion.", GroupName = "TEXT INPUT LAYOUT", DemoViewType = typeof(FeedbackFormSmartFill) });
        }
    }
