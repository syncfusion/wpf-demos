    ...
    public class TextInputLayoutProductDemos : ProductDemo
    {
        ...
        public TextInputLayoutProductDemos()
        {
            ...
            this.Demos = new List<DemoInfo>();
             this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", Description= "This sample demonstrates the basic functionality of text input layout control", GroupName = "TEXT INPUT LAYOUT", DemoViewType = typeof(TextInputLayoutGettingStartedDemo), Tag=Tag.Updated });
        }
    }
