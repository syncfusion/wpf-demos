...
namespace syncfusion.layoutdemos.wpf
{
    ...
    public class LayoutDemosViewModel : DemoBrowserViewModel
    {
        ...
        public override List<ProductDemo> GetDemosDetails()
        {
            ...
            productdemos.Add(new TabbedWindowProductDemos());
    ...
    public class TileViewProductDemos : ProductDemo
    {
        ...
        public TileViewProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", Description= "This sample showcases the basic features of TileView such as Dragging, Maximization and Minimization", GroupName = "TileView", DemoViewType = typeof(TileViewDemo) });
    ...
    /// <summary>
    /// Product demos for Tabbed Window
    /// </summary>
    public class TabbedWindowProductDemos : ProductDemo
    {
        public TabbedWindowProductDemos()
        {
            this.Product = "Tabbed Window";
            this.ProductCategory = "LAYOUT";
            this.Tag = Tag.Updated;
            this.IsHighlighted = true;
            this.ListViewImagePathData = new System.Windows.Shapes.Path()
            {
                Data = Geometry.Parse("M14 6C15.1046 6 16 6.89543 16 8V13C16 14.0357 15.2128 14.887 14.2041 14.9893L14 15H4L3.7959 14.9893C2.85435 14.8938 2.1062 14.1457 2.01074 13.2041L2 13V8C2 6.89543 2.89543 6 4 6H14ZM4 7C3.44772 7 3 7.44772 3 8V13C3 13.5523 3.44772 14 4 14H14C14.5523 14 15 13.5523 15 13V8C15 7.44772 14.5523 7 14 7H4ZM13.5 12C13.7761 12 14 12.2239 14 12.5C14 12.7761 13.7761 13 13.5 13H4.5C4.22386 13 4 12.7761 4 12.5C4 12.2239 4.22386 12 4.5 12H13.5ZM8.5 10C8.77614 10 9 10.2239 9 10.5C9 10.7761 8.77614 11 8.5 11H4.5C4.22386 11 4 10.7761 4 10.5C4 10.2239 4.22386 10 4.5 10H8.5ZM4.38379 1.01172C4.81308 1.06549 5.20196 1.30294 5.44531 1.66797L6.55469 3.33203C6.83288 3.74932 7.30122 3.99999 7.80273 4H12.5C13.1529 4 13.707 4.41766 13.9131 5H7.80273C6.96687 4.99999 6.18631 4.5822 5.72266 3.88672L4.61328 2.22266C4.52056 2.08357 4.36443 2.00001 4.19727 2H1.5C1.22386 2 1 2.22386 1 2.5V10.9121C0.464008 10.7223 0.0672443 10.2387 0.0078125 9.65332L0 9.5V2.5C0 1.67157 0.671573 1 1.5 1H4.19727L4.38379 1.01172ZM12.8965 8.14648C13.0917 7.95122 13.4083 7.95122 13.6035 8.14648C13.7988 8.34175 13.7988 8.65825 13.6035 8.85352L13.207 9.25L13.6035 9.64648C13.7988 9.84175 13.7988 10.1583 13.6035 10.3535C13.4083 10.5488 13.0917 10.5488 12.8965 10.3535L12.5 9.95703L12.1035 10.3535C11.9083 10.5488 11.5917 10.5488 11.3965 10.3535C11.2012 10.1583 11.2012 9.84175 11.3965 9.64648L11.793 9.25L11.3965 8.85352C11.2012 8.65825 11.2012 8.34175 11.3965 8.14648C11.5917 7.95122 11.9083 7.95122 12.1035 8.14648L12.5 8.54297L12.8965 8.14648ZM9.5 2C9.78 2 10 2.22 10 2.5C10 2.78 9.78 3 9.5 3H8.5C8.22 3 8 2.78 8 2.5C8 2.22 8.22 2 8.5 2H9.5ZM12.5 2C12.78 2 13 2.22 13 2.5C13 2.78 12.78 3 12.5 3H11.5C11.22 3 11 2.78 11 2.5C11 2.22 11.22 2 11.5 2H12.5Z"),
                Width = 16,
                Height = 16,
            };
            ...
            this.ControlDescription = "Tabbed window provides an advanced tabbed interface that supports flexible docking, tear‑off, re‑ordering, and seamless switching between normal and tabbed window modes. It helps organize content efficiently while offering a modern, customizable UI designed for dynamic window management.";
            this.GalleryViewImageSource = new BitmapImage(new Uri(@"/syncfusion.demoscommon.wpf;component/Assets/GalleryViewImages/Tabbed Window.png", UriKind.RelativeOrAbsolute));
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", GroupName = "Tabbed Window", DemoViewType = typeof(TabbedWindow),Tag = Tag.Updated, DemoLauchMode = DemoLauchMode.Window, ThemeMode = ThemeMode.Inherit, Description = "This sample showcases the features of TabbedWindow control such as WindowType, AllowDragDrop, EnableNewButton and CloseButton Visibility" });
            this.Demos.Add(new DemoInfo() { SampleName = "Drag and Drop", GroupName = "Tabbed Window", DemoViewType = typeof(DragDropDemo), DemoLauchMode = DemoLauchMode.Window, ThemeMode = ThemeMode.Inherit, Description = "Demonstrates drag and drop between two tab controls." });
            this.Demos.Add(new DemoInfo() { SampleName = "Window Customization", GroupName = "Tabbed Window", DemoViewType = typeof(TearOffWindowCustomizeDemo), Tag = Tag.New, DemoLauchMode = DemoLauchMode.Window, ThemeMode = ThemeMode.Inherit, Description = "Demonstrates the creation of customized TearOff window" });
        }
    }
}
