...
namespace syncfusion.layoutdemos.wpf
{
    ...
    public class TabbedWindowProductDemos : ProductDemo
    {
        public TabbedWindowProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", GroupName = "Tabbed Window", DemoViewType = typeof(TabbedWindow), Tag = Tag.New, DemoLauchMode = DemoLauchMode.Window, ThemeMode = ThemeMode.Inherit, Description = "This sample showcases the features of TabbedWindow control such as WindowType, AllowDragDrop, EnableNewButton and CloseButton Visibility" });
            this.Demos.Add(new DemoInfo() { SampleName = "Drag and Drop", GroupName = "Tabbed Window", DemoViewType = typeof(DragDropDemo), Tag = Tag.New, DemoLauchMode = DemoLauchMode.Window, ThemeMode = ThemeMode.Inherit, Description = "Demonstrates drag and drop between two tab controls." });
        }
    }
}
