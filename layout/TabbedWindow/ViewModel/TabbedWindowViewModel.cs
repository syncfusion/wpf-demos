...
namespace syncfusion.layoutdemos.wpf.ViewModel
{
    public class TabbedWindowViewModel : NotificationObject
    {
        ...
        public TabbedWindowViewModel()
        {
            ...
            TabArrangement = TabArrangement.Horizontal;
            EnableTitle = false;
            AllowDragDrop = true;
        ...
        public IReadOnlyList<TabArrangement> TabArrangementOptions { get; } =
                new[] { TabArrangement.Horizontal, TabArrangement.Vertical };
        ...
        private TabArrangement tabArrangement;

        public TabArrangement TabArrangement
        {
            get { return tabArrangement; }
            set
            {
                if (tabArrangement != value)
                {
                    tabArrangement = value;
                    RaisePropertyChanged(nameof(TabArrangement));
                }
            }
        }
    ...
    public class TabItemModel : NotificationObject
    {
        ...
        {
            get => _showPinButton;
            set { if (_showPinButton != value) { _showPinButton = value; RaisePropertyChanged(nameof(ShowPinButton)); } }
        }
