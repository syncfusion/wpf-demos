...
namespace syncfusion.mapdemos.wpf
{
    ...
    public class MapProductDemos : ProductDemo
    {
        public MapProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Smart Location Finder", IsAISample = true, GroupName = "MAP", Tag = Tag.New, DemoViewType = typeof(LocationIndicator), Description = "This sample allows users to search for and find locations." });
        }
    }
}
