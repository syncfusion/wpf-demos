...
namespace syncfusion.mapdemos.wpf
{
    ...
    public class MapProductDemos : ProductDemo
    {
        public MapProductDemos()
        {
            ...
            // this.Demos.Add(new DemoInfo() { SampleName = "Map Export", GroupName = "Export", DemoViewType = typeof(MapExportDemo), Tag = Tag.New, Description = "This sample demonstrates the Map’s export functionality, enabling users to change the map type (Geometric or OSM) and export the Map in PNG, JPEG or SVG format." });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Smart Location Finder", IsAISample = true, GroupName = "MAP", DemoViewType = typeof(LocationIndicator), Description = "This sample allows users to search for and find locations." });
        }
    }
}
