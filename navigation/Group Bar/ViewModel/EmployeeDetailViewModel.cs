...
namespace syncfusion.navigationdemos.wpf
{
    public class EmployeeDetailViewModel :NotificationObject
    {
        ...
        {
            SampleList.Add(new EmployeeDetailModel() { Header = "Buchanan", Age = "25", Location = "Washington D.C.", DateOfBirth = "02/25/1984", Image = @"/syncfusion.demoscommon.wpf;component/Assets/People/People_Circle14.png" });
            SampleList.Add(new EmployeeDetailModel() { Header = "Callahan", Age = "19", Location = "Costa Rica", DateOfBirth = "10/16/1990", Image = @"/syncfusion.demoscommon.wpf;component/Assets/People/People_Circle23.png" });
            SampleList.Add(new EmployeeDetailModel() { Header = "Fuller", Age = "35", Location = "Carolina", DateOfBirth = "09/24/1970", Image = @"/syncfusion.demoscommon.wpf;component/Assets/People/People_Circle31.png" });
            SampleList.Add(new EmployeeDetailModel() { Header = "Lever Ling", Age = "28", Location = "New York", DateOfBirth = "08/26/1985", Image = @"/syncfusion.demoscommon.wpf;component/Assets/People/People_Circle33.png" });
            SampleList.Add(new EmployeeDetailModel() { Header = "King", Age = "20", Location = "Canada", DateOfBirth = "12/19/1984", Image = @"/syncfusion.demoscommon.wpf;component/Assets/People/People_Circle35.png" });
        }
