...
namespace syncfusion.navigationdemos.wpf
{
    ...
    public class MenuMergingViewModel : NotificationObject
    {
        ...
        public MenuMergingViewModel()
        {
            ...
            HelpModel.MenuMergingCollection.Add(new MenuMergingModel() { Name = "Online Help", Icon = CommonResourceDictionary["Help"] as object, Command = HelpCommand });
            HelpModel.MenuMergingCollection.Add(new MenuMergingModel() { Name = "About", Command = AboutCommand });
