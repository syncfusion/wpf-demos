...
namespace syncfusion.navigationdemos.wpf
{
    ...
    public class NavigationDrawerProductDemos : ProductDemo
    {
        ...
        public NavigationDrawerProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", GroupName = "Navigation Drawer", Description = "This sample showcase the basic functionalities of NavigationDrawer.", DemoViewType = typeof(DisplayMode), ThemeMode = ThemeMode.Inherit, Tag = Tag.New });
            this.Demos.Add(new DemoInfo() { SampleName = "Data Binding", GroupName = "Navigation Drawer", Description = "This sample showcases the items populated with the collection of business objects using ItemsSource in NavigationDrawer.", DemoViewType = typeof(NavigationDrawerDataBinding), ThemeMode = ThemeMode.Inherit, Tag = Tag.New });
            this.Demos.Add(new DemoInfo() { SampleName = "Footer Items", GroupName = "Navigation Drawer", Description = "This sample showcase the FooterItems support in NavigationDrawer.", DemoViewType = typeof(FooterItems), ThemeMode = ThemeMode.Inherit, Tag = Tag.New });
            this.Demos.Add(new DemoInfo() { SampleName = "Hierarchical Collection", GroupName = "Navigation Drawer", Description = "This sample showcase the hierarchical levels of items placed inside the drawer menu when using compact and expanded display mode.", DemoViewType = typeof(HierarchicalCollection), ThemeMode = ThemeMode.Inherit, Tag = Tag.New });
    ...
    public class TabControlExtProductDemos : ProductDemo
    {
        public TabControlExtProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Auto Scroll", Description = "This sample showcases the TabControl's Auto Scroll property", GroupName = "TabControlExt", DemoViewType = typeof(AutoScrollDemosView),Tag = Tag.Updated});
        }
    }
