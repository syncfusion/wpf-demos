...
namespace syncfusion.navigationdemos.wpf
{
    ...
    public class NavigationDrawerProductDemos : ProductDemo
    {
        ...
        public NavigationDrawerProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", GroupName = "Navigation Drawer", Description = "The NavigationDrawer is a sliding panel menu that allows you to navigate between the major modules of the application. The Navigation Drawer is usually hidden, and it appears when you swipe the screen from any of the four edges or by tapping the app icon, if available.", DemoViewType = typeof(NavigationDrawerDemosView), DemoLauchMode = DemoLauchMode.Window , ThemeMode = ThemeMode.Default });
            this.Demos.Add(new DemoInfo() { SampleName = "Display Mode", GroupName = "Navigation Drawer", Description = "This sample showcase the compact and expanded display mode support in NavigationDrawer", DemoViewType = typeof(DisplayMode), ThemeMode = ThemeMode.None, Tag = Tag.New});
            this.Demos.Add(new DemoInfo() { SampleName = "Hierarchical Collection", GroupName = "Navigation Drawer", Description = "This sample showcase the hierarchical levels of items placed inside the drawer menu when using compact and expanded display mode.", DemoViewType = typeof(HierarchicalCollection), ThemeMode = ThemeMode.None,Tag = Tag.New });
        }
    }
