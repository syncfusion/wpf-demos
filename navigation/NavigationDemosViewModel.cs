...
namespace syncfusion.navigationdemos.wpf
{
    ...
    public class NavigationDrawerProductDemos : ProductDemo
    {
        ...
        public NavigationDrawerProductDemos()
        {
            ...
            DemoInfo GettingStartedNavigationDrawerDemo = new DemoInfo()
            {
                SampleName = "Getting Started", GroupName = "Navigation Drawer", Description = "This sample showcase the basic functionalities of NavigationDrawer.", DemoViewType = typeof(DisplayMode), ThemeMode = ThemeMode.Inherit
            };
            List<Documentation> GettingStartedNavigationDrawerDocuments = new List<Documentation>()
            {
                new Documentation(){ Content="Navigation Drawer - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/navigation-drawer/getting-started")},
            };
            GettingStartedNavigationDrawerDemo.Documentations = GettingStartedNavigationDrawerDocuments;
            this.Demos.Add(GettingStartedNavigationDrawerDemo);
            DemoInfo DataBindingNavigationDemo = new DemoInfo()
            {
                SampleName = "Data Binding", GroupName = "Navigation Drawer", Description = "This sample showcases the items populated with the collection of business objects using ItemsSource in NavigationDrawer.", DemoViewType = typeof(NavigationDrawerDataBinding), ThemeMode = ThemeMode.Inherit
            };
            List<Documentation> DataBindingNavigationDocuments = new List<Documentation>()
            {
                new Documentation(){ Content="Navigation Drawer - Data Binding", Uri = new Uri("https://help.syncfusion.com/wpf/navigation-drawer/populating-data#data-binding")},
            };
            DataBindingNavigationDemo.Documentations = DataBindingNavigationDocuments;
            this.Demos.Add(DataBindingNavigationDemo);

            DemoInfo FooterItemsNavigationDemo = new DemoInfo()
            {
                SampleName = "Footer Items", GroupName = "Navigation Drawer", Description = "This sample showcase the FooterItems support in NavigationDrawer.", DemoViewType = typeof(FooterItems), ThemeMode = ThemeMode.Inherit
            };
            List<Documentation> FooterItemsNavigationDocuments = new List<Documentation>()
            {
                new Documentation(){ Content="Navigation Drawer - Footer Items", Uri = new Uri("https://help.syncfusion.com/wpf/navigation-drawer/header-and-footer")},
            };
            FooterItemsNavigationDemo.Documentations = FooterItemsNavigationDocuments;
            this.Demos.Add(FooterItemsNavigationDemo);
            
            DemoInfo HierarchicalCollectionDemo = new DemoInfo()
            {
                SampleName = "Hierarchical Collection",
                GroupName = "Navigation Drawer",
                Description = "This sample showcase the hierarchical levels of items placed inside the drawer menu when using compact and expanded display mode.",
                DemoViewType = typeof(HierarchicalCollection),
                ThemeMode = ThemeMode.Inherit
            };
            List<Documentation> HierarchicalCollectionDocuments = new List<Documentation>()
            {
                new Documentation(){ Content="Navigation Drawer - Hierarchical Collection", Uri = new Uri("https://help.syncfusion.com/wpf/navigation-drawer/populating-data#hierarchical-data-binding")},
            };
            HierarchicalCollectionDemo.Documentations = HierarchicalCollectionDocuments;
            this.Demos.Add(HierarchicalCollectionDemo);
            ...
            DemoInfo CustomViewsNavigationDemo = new DemoInfo()
            {
            ...
            List<Documentation> CustomViewsNavigationDocuments = new List<Documentation>()
            {
                new Documentation(){ Content="Navigation Drawer - Custom Views", Uri = new Uri("https://help.syncfusion.com/wpf/navigation-drawer/custom-views")},
            };
            CustomViewsNavigationDemo.Documentations = CustomViewsNavigationDocuments;
            this.Demos.Add(CustomViewsNavigationDemo);
            }
    }
    ...
    public class ToolBarProductDemos : ProductDemo
    {
        ...
        public ToolBarProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", GroupName = "Tool Bar", DemoViewType = typeof(ToolBarDemosView), Description = "This sample showcases the basic features of customizing and positioning of ToolBarTrayAdv in ToolBarAdv control.", ThemeMode = ThemeMode.Default });
        }
    }
    ...
    public class RadialMenuProductDemos : ProductDemo
    {
        ...
        public RadialMenuProductDemos()
        {
            ...
            DemoInfo GettingStartedRadialMenuDemo = new DemoInfo()
            {
                SampleName = "Getting Started", GroupName = "Radial Menu", Description = "This sample showcases a simple use case scenario having an editor loaded with Radial Menu with editor options loaded with the items of the Radial Menu.", DemoViewType = typeof(RadialMenuDemosView),
            };
            List<Documentation> GettingStartedRadialMenuDocuments = new List<Documentation>()
            {
                new Documentation(){ Content="Radial Menu - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/radial-menu/getting-started")},
            };
            GettingStartedRadialMenuDemo.Documentations = GettingStartedRadialMenuDocuments;
            this.Demos.Add(GettingStartedRadialMenuDemo);
        }
    }
}
