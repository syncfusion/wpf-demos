...
namespace syncfusion.notificationdemos.wpf
{
    ...
    public class NotificationDemosViewModel : DemoBrowserViewModel
    {
        ...
        public override List<ProductDemo> GetDemosDetails()
        {
            ...
            productdemos.Add(new ToastNotificationProductDemos());
            return productdemos;
        }
    }
    ...
    public class ProgressbarProductDemos : ProductDemo
    {
        ...
        public ProgressbarProductDemos()
        {
            ...
            List<Documentation> LinearProgressBar = new List<Documentation>()
            {
                new Documentation(){ Content = "Linear ProgressBar - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/linear-progressbar/getting-started")}
            };
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", GroupName = "Linear ProgressBar", Description = "This sample showcases the features supported by Linear ProgressBar.", DemoViewType = typeof(LinearProgressBar), Documentations = LinearProgressBar });

            List<Documentation> CircularProgressBar = new List<Documentation>()
            {
                new Documentation(){ Content = "Circular ProgressBar - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/circular-progressbar/getting-started")}
            };
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", GroupName = "Circular ProgressBar", Description = "This sample showcases the features supported by Circular ProgressBar.", DemoViewType = typeof(CircularProgressBar), Documentations = CircularProgressBar });

            List<Documentation> ShipmentTracking = new List<Documentation>()
            {
                new Documentation(){ Content = "Step ProgressBar - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/step-progressbar/getting-started")}
            };
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", GroupName = "Step ProgressBar", Description = "This sample demonstrates how to create a shipment tracking process using the Syncfusion StepProgressBar control.", DemoViewType = typeof(ShipmentTracking), Documentations = ShipmentTracking });

            List<Documentation> StepProgressBarCustomization = new List<Documentation>()
            {
                new Documentation(){ Content = "Step ProgressBar - Customization", Uri = new Uri("https://help.syncfusion.com/wpf/step-progressbar/customizing-data-templates")}
            };
            this.Demos.Add(new DemoInfo() { SampleName = "Customization", ThemeMode = ThemeMode.Default, Description = "This sample demonstrates how to customize the MarkerTemplate, SecondaryContent and Content in StepProgressBar control.", GroupName = "Step ProgressBar", DemoViewType = typeof(StepProgressBarCustomization), Documentations = StepProgressBarCustomization });
        }
    }
    ...
    public class BusyIndicatorProductDemos : ProductDemo
    {
        ...
        public BusyIndicatorProductDemos()
        {
            ...
            DemoInfo GettingStartedBusyIndicatorDemo = new DemoInfo()
            {
                SampleName = "Getting Started",
                GroupName = "BUSY INDICATOR",
                Description = "This sample showcases the Animation types and Busy status of SfBusyIndicator.",
                DemoViewType = typeof(GettingStarted),
            };

            List<Documentation> GettingStartedBusyIndicatorDocumentation = new List<Documentation>()
            {

                new Documentation(){ Content="BusyIndicator - Getting Started", Uri = new Uri("https://help.syncfusion.com/wpf/busy-indicator/getting-started")},
                new Documentation(){ Content="BusyIndicator - Animation Types", Uri = new Uri("https://help.syncfusion.com/wpf/busy-indicator/animationtypes")},
            };

            GettingStartedBusyIndicatorDemo.Documentations = GettingStartedBusyIndicatorDocumentation;
            this.Demos.Add(GettingStartedBusyIndicatorDemo);
    ...
    /// Class represents the notification product demos
    /// </summary>
    public class ToastNotificationProductDemos : ProductDemo
    {
        /// <summary>
        /// Initializes the new instance of <see cref="ToastNotificationProductDemos"/> class.
        /// </summary>
        public ToastNotificationProductDemos()
        {
            this.Product = "Toast Notification";
            this.ProductCategory = "NOTIFICATION";
            this.Tag = Tag.New;
            this.IsHighlighted = true;
            this.ListViewImagePathData = new System.Windows.Shapes.Path()
            {
                Data = Geometry.Parse("M14 3C15.1046 3 16 3.89543 16 5V11C16 12.1046 15.1046 13 14 13H2C0.964349 13 0.113005 12.2128 0.0107422 11.2041L0 11V5C0 3.89543 0.895431 3 2 3H14ZM2 4C1.44772 4 1 4.44772 1 5V11C1 11.5523 1.44772 12 2 12H14C14.5523 12 15 11.5523 15 11V5C15 4.44772 14.5523 4 14 4H2ZM11.5 9C11.7761 9 12 9.22386 12 9.5C12 9.77614 11.7761 10 11.5 10H2.5C2.22386 10 2 9.77614 2 9.5C2 9.22386 2.22386 9 2.5 9H11.5ZM6.5 7C6.77614 7 7 7.22386 7 7.5C7 7.77614 6.77614 8 6.5 8H2.5C2.22386 8 2 7.77614 2 7.5C2 7.22386 2.22386 7 2.5 7H6.5ZM12.8965 5.14648C13.0917 4.95122 13.4083 4.95122 13.6035 5.14648C13.7988 5.34175 13.7988 5.65825 13.6035 5.85352L13.207 6.25L13.6035 6.64648C13.7988 6.84175 13.7988 7.15825 13.6035 7.35352C13.4083 7.54878 13.0917 7.54878 12.8965 7.35352L12.5 6.95703L12.1035 7.35352C11.9083 7.54878 11.5917 7.54878 11.3965 7.35352C11.2012 7.15825 11.2012 6.84175 11.3965 6.64648L11.793 6.25L11.3965 5.85352C11.2012 5.65825 11.2012 5.34175 11.3965 5.14648C11.5917 4.95122 11.9083 4.95122 12.1035 5.14648L12.5 5.54297L12.8965 5.14648Z"),
                Width = 16,
                Height = 16
            };
            this.Demos = new List<DemoInfo>();
            this.HeaderImageSource = new BitmapImage(new Uri(@"/syncfusion.demoscommon.wpf;component/Assets/ProductCategoryImages/Notification.png", UriKind.RelativeOrAbsolute));
            this.ControlDescription = "The Toast Notification control is used to present brief, timely alerts that notify users about important events, updates, or actions without interrupting their workflow.";
            this.GalleryViewImageSource = new BitmapImage(new Uri(@"/syncfusion.demoscommon.wpf;component/Assets/GalleryViewImages/SfToast.png", UriKind.RelativeOrAbsolute));
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started",Tag = Tag.New, Title = "InApp Toasts", GroupName = "SfToastNotification", DemoViewType = typeof(GettingStartedSample), ThemeMode = ThemeMode.Inherit, Description = "This sample demonstrates the customizable SfToastNotification control, showcasing support for custom layouts, appearance settings, animation behaviors, display duration, and interactive actions within the application." });
            this.Demos.Add(new DemoInfo() { SampleName = "Customization",Tag=Tag.New, Title = "InApp Toasts", GroupName = "SfToastNotification", DemoViewType = typeof(ToastCustomizationDemo), ThemeMode = ThemeMode.Inherit, Description = "This sample demonstrates customizing the in-app SfToastNotification with Foreground, Background, BorderBrush, and templating for Title, Content, Close button, and Action buttons, along with visibility options for ShowCloseButton and ShowActionButtons." });
            this.Demos.Add(new DemoInfo() { SampleName = "Native/System Toast",Tag=Tag.New, Title = "OS Toasts", GroupName = "SfToastNotification", DemoViewType = typeof(OSToastDemo), ThemeMode = ThemeMode.Inherit, Description = "This sample demonstrates how the SfToastNotification control integrates with the native operating system to display system-level alerts using built-in toast templates and notification services" });
        }
    }
}
