...
namespace syncfusion.notificationdemos.wpf
{
    ...
    public class BadgeProductDemos : ProductDemo
    {
        ...
        public BadgeProductDemos()
        {
            ...
            this.Tag = Tag.New;
            this.Demos = new List<DemoInfo>();
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", Title = "Shapes", Tag=Tag.New, GroupName = "Badge", DemoViewType = typeof(GettingStartedDemo), ThemeMode = ThemeMode.Inherit, Description = "This sample demonstrates the default and custom shapes, fill colors, anchor and alignment support available in Badge control." });
            this.Demos.Add(new DemoInfo() { SampleName = "Embed with Other Controls", Title = "Embed with Other Controls", Tag = Tag.New, GroupName = "Badge", DemoViewType = typeof(IntegrateWithOtherControlsDemo), ThemeMode = ThemeMode.Inherit, Description = "This sample demonstrates how the Badge control embed with ListView and RibbonButton controls." });
        }
    }
}
