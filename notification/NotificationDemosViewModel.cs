...
namespace syncfusion.notificationdemos.wpf
{
    ...
    public class ProgressbarProductDemos : ProductDemo
    {
        ...
        public ProgressbarProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", Tag = Tag.Updated, GroupName = "Linear ProgressBar", Description = "This sample showcases the features supported by Linear ProgressBar." , DemoViewType = typeof(LinearProgressBar) });
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", Tag = Tag.Updated, GroupName = "Circular ProgressBar", Description = "This sample showcases the features supported by Circular ProgressBar." , DemoViewType = typeof(CircularProgressBar) });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Customization", ThemeMode = ThemeMode.Default, Tag = Tag.Updated, Description = "This sample demonstrates how to customize the MarkerTemplate, SecondaryContent and Content in StepProgressBar control.", GroupName = "Step ProgressBar", DemoViewType = typeof(StepProgressBarCustomization) });
        }
    }
    ...
    public class BadgeProductDemos : ProductDemo
    {
        ...
        public BadgeProductDemos()
        {
            ...
            this.Demos = new List<DemoInfo>();
            this.Demos.Add(new DemoInfo() { SampleName = "Getting Started", Title = "Shapes", Tag=Tag.Preview, GroupName = "Badge", DemoViewType = typeof(GettingStartedDemo), ThemeMode = ThemeMode.Inherit, Description = "This sample demonstrates the default and custom shapes, fill colors, anchor and alignment support available in Badge control." });
            this.Demos.Add(new DemoInfo() { SampleName = "Embed with Other Controls", Title = "Embed with Other Controls", Tag = Tag.Preview, GroupName = "Badge", DemoViewType = typeof(IntegrateWithOtherControlsDemo), ThemeMode = ThemeMode.Inherit, Description = "This sample demonstrates how the Badge control embed with ListView and RibbonButton controls." });
        }
    }
}
