...
namespace syncfusion.olapchartdemos.wpf
{
    ...
    /// <summary>
    /// Representation of the ExportingCustomization class.
    /// </summary>
    public class ExportingCustomization : TargetedTriggerAction<OlapChart>
    {
        ...
        {
            string wordpath = System.IO.Path.GetFullPath(@"Data\olapchart\TemplateDocument\Document.doc");
            string pdfpath = System.IO.Path.GetFullPath(@"Data\olapchart\TemplateDocument\PdfDocument.pdf");
            string outputpath = System.IO.Path.GetFullPath(@"Data\olapchart\OutputDocument\Document.doc");
