...
namespace syncfusion.olapchartdemos.wpf
{
    ...
    /// <summary>
    /// Representation of the MDXQueryViewModel class.
    /// </summary>
    public class MDXQueryViewModel : NotificationObject, IDisposable
    {
        #region Members
        ...
        /// <summary>Gets or sets the currently selected MDX query string.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether MDX parsing to OLAP reports is allowed.</summary>
        ...
        /// <summary>Gets or sets the current MDX query being executed.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether the 'All' level type should be shown.</summary>
        ...
        /// <summary>
        /// Gets the command that displays the MDX query window.
        /// </summary>
        ...
        /// <summary>
        /// Gets the command that executes the MDX processing logic.
        /// </summary>
        ...
        /// <summary>
        /// Gets the command that cancels the MDX processing operation.
        /// </summary>
