...
namespace syncfusion.olapchartdemos.wpf
{
    ...
    /// <summary>
    /// Representation of the ReportInFileViewModel class.
    /// </summary>
    public class ReportInFileViewModel : INotifyPropertyChanged, IDisposable
    {
        ...
        public ReportInFileViewModel()
        {
            ...
            this.olapDataManager.LoadReportDefinitionFile(System.IO.Path.GetFullPath(@"Assets\Olap\Data\CubeModelTemplates\ReportDefenitionFile.xml"));
        ...
        private void BrowseReport(object parm)
        {
            ...
            openFileDialog.InitialDirectory = System.IO.Path.GetFullPath(@"Assets\Olap\Data\CubeModelTemplates");
