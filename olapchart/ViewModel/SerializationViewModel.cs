...
namespace syncfusion.olapchartdemos.wpf
{
    ...
    /// <summary> Representation of the SerializationViewModel class</summary>
    public class SerializationViewModel : NotificationObject, IDisposable
    {
        ...
        /// <summary> Gets a collection of available brush color names. </summary>
        ...
        /// <summary> Gets the collection of available chart color palettes. </summary>
