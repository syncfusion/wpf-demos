...
namespace syncfusion.olapclientdemos.wpf
{
        ...
        : Window, INotifyPropertyChanged
    {
        ...
        public static readonly DependencyProperty TileHeaderProperty =
            DependencyProperty.Register("TileHeader", typeof(string), typeof(BIDashboard), new UIPropertyMetadata(string.Empty));

        public static readonly DependencyProperty ReportLocationProperty =
            DependencyProperty.Register("ReportLocation", typeof(Report), typeof(BIDashboard), new UIPropertyMetadata(null));
