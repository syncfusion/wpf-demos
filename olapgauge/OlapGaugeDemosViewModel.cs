...
namespace syncfusion.olapgaugedemos.wpf
{
    ...
    public class OlapGaugeProductDemos : ProductDemo
    {
        public OlapGaugeProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "KPI", GroupName = "PRODUCT SHOWCASE", DemoViewType = typeof(KPI), Description = "OlapGauge for WPF helps in choosing scenarios dynamically, by which KPI information is highlighted via Value ToolTip and Goal ToolTip.", ThemeMode = ThemeMode.None });
