...
namespace syncfusion.olapgriddemos.wpf
{
    ...
    internal class TransactionModel : IDisposable
    {
        ...
        public TransactionModel()
        {
            ...
            {
                string path = "";
                path = System.IO.Path.GetFullPath(@"Assets");
                this.dbConnection = new OleDbConnection(@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + path + "\\Olap\\Data\\Sales DB.xls;Extended Properties=Excel 8.0;");
            }
            catch
            {
                //Return
