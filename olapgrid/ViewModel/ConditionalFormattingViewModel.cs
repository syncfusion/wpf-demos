...
namespace syncfusion.olapgriddemos.wpf
{
    ...
    /// </summary>
    public class ConditionalFormattingViewModel : NotificationObject, IDisposable
    {
        #region Members
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ConditionalFormattingViewModel"/> class.
        /// </summary>
