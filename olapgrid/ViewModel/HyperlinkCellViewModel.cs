...
namespace syncfusion.olapgriddemos.wpf
{
    ...
    /// </summary>
    public class HyperlinkCellViewModel : NotificationObject, IDisposable
    {
        #region Members
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HyperlinkCellViewModel"/> class.
        /// </summary>
        public HyperlinkCellViewModel()
        {
