...
namespace syncfusion.pdfdemos.wpf
{
    ...
    public class PdfProductDemos : ProductDemo
    {
        public PdfProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Graphic Brushes", GroupName = "Graphics", DemoViewType = typeof(GraphicBrushes), Description = "This sample demonstrates the support for creating and filling shapes with the various types of brushes that are supported by Essential PDF.", Tag = Tag.Updated });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Autotag", GroupName = "Accessibility", DemoViewType = typeof(AutoTag), Description = "This sample demonstrates how to create a tagged PDF document using Essential PDF.", Tag = Tag.Updated });
