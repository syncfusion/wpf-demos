...
namespace syncfusion.pdfdemos.wpf
{
    ...
    public class PdfProductDemos : ProductDemo
    {
        public PdfProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Annotations", GroupName = "User Interaction", DemoViewType = typeof(AnnotationFlatten), Description = "This sample demonstrates Essential PDF's support annotation flatten feature.", Tag = Tag.Updated });
...
#endif			
            this.Demos.Add(new DemoInfo() { SampleName = "PDF Conformance", GroupName = "Conformance", DemoViewType = typeof(PDFConformance), Description = "This sample demonstrates various PDF conformance support in Essential PDF.", Tag = Tag.Updated });
            this.Demos.Add(new DemoInfo() { SampleName = "PDF to PDF-A", GroupName = "Conformance", DemoViewType = typeof(PDFToPDFA1b), Description = "This sample demonstrates how to convert PDF document into PDF/A conformance document using Essential Pdf.", Tag = Tag.Updated });
