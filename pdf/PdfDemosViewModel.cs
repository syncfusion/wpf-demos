...
namespace syncfusion.pdfdemos.wpf
{
    ...
    public class PdfProductDemos : ProductDemo
    {
        public PdfProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Split Document", GroupName = "Modify Documents", DemoViewType = typeof(SplitDocument), Description = "This sample demonstrates how to split the pages of a PDF into multiple PDF documents, ensuring that their accessibility tags remain unchanged.", Tag = Tag.Updated });
