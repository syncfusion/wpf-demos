...
namespace syncfusion.pdfdemos.wpf
{
    ...
    public class PdfProductDemos : ProductDemo
    {
        public PdfProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "ZUGFeRD Invoice", GroupName = "Product Showcase", DemoViewType = typeof(ZugFerd),  Description= "This sample demonstrates how to create ZUGFeRD PDF invoice using Essential PDF",Tag = Tag.Updated  });
