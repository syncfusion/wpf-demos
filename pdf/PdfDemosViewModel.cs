...
namespace syncfusion.pdfdemos.wpf
{
    ...
    public class PdfProductDemos : ProductDemo
    {
        public PdfProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Merge Documents", GroupName = "Modify Documents", DemoViewType = typeof(MergeDocuments), Description = "This sample demonstrates how to merge multiple PDF documents using Essential PDF." , Tag= Tag.Updated});
