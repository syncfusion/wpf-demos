...
namespace syncfusion.pdfdemos.wpf
{
    ...
    public class PdfProductDemos : ProductDemo
    {
        public PdfProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Redaction", GroupName = "Security", DemoViewType = typeof(Redaction), Description = "This sample demonstrates the redaction of PDF documents. Redaction is used to remove confidential information from PDF document.",Tag = Tag.Updated });
			...
			this.Demos.Add(new DemoInfo() { SampleName = "Remove Images", GroupName = "Modify Documents", DemoViewType = typeof(RemoveImage), Description = "This sample demonstrates how to remove images from an existing PDF" , Tag = Tag.New });
