...
namespace syncfusion.pivotgriddemos.wpf
{
    ...
    public class PivotGridProductDemos : ProductDemo
    {
        public PivotGridProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Cell Template", GroupName = "APPEARANCE", DemoViewType = typeof(CellTemplate), Description = "This sample illustrates the procedure to apply templates to header cells.", Documentations = cellTemplateDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Conditional Formatting", GroupName = "APPEARANCE", DemoViewType = typeof(ConditionalFormatting), Description = "This sample illustrates the procedure to apply formatting for PivotGrid cells based on certain conditions.", Documentations = conditionalFormattingDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Color Scales", GroupName = "APPEARANCE", DemoViewType = typeof(ColorScales), Description = "This sample illustrates the procedure to apply formatting for Pivot Grid cells based on certain conditions using gradient color scales.", Documentations = colorScalesDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Hyperlink Cell", GroupName = "APPEARANCE", DemoViewType = typeof(HyperlinkCell), Description = "This sample illustrates about hyperlink support in PivotGrid.", Documentations = hyperlinkCellDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "State Persistence", GroupName = "APPEARANCE", DemoViewType = typeof(StatePersistence), Description = "This sample illustrates on how to persist expand and collapse state in PivotGrid.", Documentations = statePersistenceDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "ToolTip", GroupName = "APPEARANCE", DemoViewType = typeof(ToolTip), Description = "This sample illustrates the usage of tooltip in PivotGrid.", Documentations = toolTipDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Summary Display", GroupName = "APPEARANCE", DemoViewType = typeof(SummaryDisplayOption), Description = "This sample illustrates the display options available in PivotGrid.", Documentations = summaryDisplayDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Field List", GroupName = "FIELD LIST", DemoViewType = typeof(FieldList), Description = "This sample demonstrates about PivotGrid's Field List that allows you to add or remove an item, to or from PivotGrid's Grouping Bar.", Documentations = fieldListDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Grouping Bar", GroupName = "GROUPING BAR", DemoViewType = typeof(GroupingBar), Description = "This sample illustrates the usage of Grouping Bar in PivotGrid for handling sorting and filtering operations.", Documentations = groupingBarDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Context Menu", GroupName = "GROUPING BAR", DemoViewType = typeof(ContextMenu), Description = "This sample illustrates the context menu support in PivotGrid.", Documentations = contextMenuDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Editing", GroupName = "INTERACTIVE FEATURES", DemoViewType = typeof(PivotEditing), Description = "This sample illustrates the usage of editing Value Cells and Total Cells at run time.", Documentations = editingDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Filtering", GroupName = "INTERACTIVE FEATURES", DemoViewType = typeof(Filtering), Description = "This feature provides programmatic level support to apply filtering (Add, Remove, Insert, RemoveAt and InsertAt) to PivotGrid.", Documentations = filteringDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Sorting", GroupName = "INTERACTIVE FEATURES", DemoViewType = typeof(Sorting), Description = "This feature allows users to sort column values in ascending or descending order by clicking on column header.", Documentations = sortingDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Updating", GroupName = "INTERACTIVE FEATURES", DemoViewType = typeof(PivotUpdating), Description = "This sample illustrates the dynamic update of value cells and how to save changes to the underlying datasource at runtime.", Documentations = updatingDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Expression Fields", GroupName = "EXPRESSION FIELDS", DemoViewType = typeof(ExpressionFields), Description = "This sample illustrates the way to add filter expression fields to PivotGrid.", Documentations = expressionFieldsDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Exporting", GroupName = "EXPORTING", DemoViewType = typeof(Exporting), Description = "PivotGrid for WPF provides an option for exporting to Excel, Word and PDF formats.", Documentations = exportingDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Printing", GroupName = "PRINTING", DemoViewType = typeof(Printing), Description = "This sample illustrates how to print the PivotGrid control.", Documentations = printingDocumentation});
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Serialization", GroupName = "SERIALIZATION", DemoViewType = typeof(Serialization), Description = "This sample illustrates the serialization support available in the PivotGrid control.", Documentations = serializationDocumentation});
        }
    }
}
