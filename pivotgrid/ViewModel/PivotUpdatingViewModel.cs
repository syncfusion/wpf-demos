...
namespace syncfusion.pivotgriddemos.wpf
{
    ...
    public class PivotUpdatingViewModel : NotificationObject
    {
        ...
        #region Properties
        private UpdateProductSales.ProductSalesCollection productSalesData;

        /// <summary>
        /// Gets or sets the product sales data.
        /// </summary>
        /// <value>The product sales data.</value>
        public UpdateProductSales.ProductSalesCollection ProductSalesData
        {
            get
            {
                this.productSalesData = this.productSalesData ?? UpdateProductSales.GetSalesData();
