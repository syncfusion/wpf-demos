...
namespace syncfusion.pivotgriddemos.wpf
{
    ...
    /// </summary>
    public class PrintViewModel : ProductSalesViewModel
    {
        ...
        public ICommand HeaderCommand
        {
            get
            {
                this.headerCommand = new DelegateCommand(param => this.HeaderTemplate = (DataTemplate)param);
        ...
        public ICommand FooterCommand
        {
            get
            {
                this.footerCommand = new DelegateCommand(param => this.FooterTemplate = (DataTemplate)param);
