...
namespace syncfusion.ribbondemos.wpf
{
    ...
    public class RibbonProductDemos : ProductDemo
    {
        ...
        public RibbonProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Application Menu",Tag=Tag.New,GroupName = "Getting Started", ThemeMode = ThemeMode.Inherit, DemoViewType = typeof(ApplicationMenu), Title = "Application Menu", DemoLauchMode = DemoLauchMode.Window, Description = "This samples showcases the application menu support in Ribbon control." });
