...
namespace syncfusion.ribbondemos.wpf
{
    ...
    public class BackstageViewModel : NotificationObject
    {
        ...
        /// </summary>
        string filePath = @"/syncfusion.ribbondemos.wpf;component/Data/Ribbon/temp.rtf";
        ...
        /// <summary>
        /// Maintains the command to visible the File menu button.
        /// </summary>
        private ICommand checkedCommand;

        /// <summary>
        /// Maintains the command to collapse the File menu button.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command to visible the File menu button <see cref="BackstageViewModel"/> class.
        /// </summary>      
        ...
        /// <summary>
        /// Gets or sets the command to collapse the File menu button <see cref="BackstageViewModel"/> class.
        /// </summary>      
        ...
        /// <summary>
        /// Gets or sets the command for backstage animation duration <see cref="BackstageViewModel"/> class.
        /// </summary>
        ...
        {          
            ...
            checkedCommand = new DelegateCommand<object>(ExecuteCheckedCommand);
            unCheckedCommand = new DelegateCommand<object>(ExecuteUncheckedCommand);
        }
        ...
        /// <summary>
        /// Method to execute the command to visible the File menu button.
        /// </summary>
        /// <param name="parameter">Specifies the object type parameter.</param>
        private void ExecuteCheckedCommand(object parameter)
        {
            ribbon.BackStageButton.Visibility = Visibility.Visible;
        }

        /// <summary>
        /// Method to execute the command to collapse the File menu button.
        /// </summary>
        /// <param name="parameter">Specifies the object type parameter.</param>
        private void ExecuteUncheckedCommand(object parameter)
        {
