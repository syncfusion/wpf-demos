...
namespace syncfusion.ribbondemos.wpf
{
    ...
    {        
        ...
        /// <summary>
        /// Handles changes to the Ribbon dependency property.
        /// </summary>
        /// <param name="obj">Specifies the dependency object.</param>
        /// <param name="args">Specifies the dependency property changes event args.</param>
        private static void OnRibbonChanged(DependencyObject obj, DependencyPropertyChangedEventArgs args)
        {
            if (obj is FrameworkElement element && element.DataContext is GettingStartedViewModel viewModel)
            {
                viewModel.ribbon = args.NewValue as Ribbon;
            }
        }
        ...
        /// <summary>
        /// Gets or sets the command for closing the application menu <see cref="GettingStartedViewModel"/> class.
        /// </summary>
