...
namespace syncfusion.ribbondemos.wpf
{
    ...
    /// </summary>
    public class SimplifiedRibbonViewModel : NotificationObject
    {        
        /// <summary>
        ...
        /// <summary>
        /// Maintains the command for the selected font.
        /// </summary>
        private ICommand selectedFontCommand;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        public SimplifiedRibbonViewModel()
        {
            ...
            selectedFontCommand = new DelegateCommand<object>(ExecuteSelectedFontCommand);
        ...
        /// <summary>
        /// Indicates whether the format is bold or not <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Indicates whether the format is italic or not <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Indicates whether the format is underline or not <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        public static readonly DependencyProperty RibbonProperty =
            DependencyProperty.RegisterAttached("Ribbon", typeof(Ribbon), typeof(SimplifiedRibbonViewModel), new FrameworkPropertyMetadata(OnRibbonChanged));
        ...
        public static readonly DependencyProperty RichTextBoxProperty =
            DependencyProperty.RegisterAttached("RichTextBox", typeof(string), typeof(SimplifiedRibbonViewModel), new FrameworkPropertyMetadata(OnRichTextBoxChanged));
        ...
        /// <summary>
        /// Gets or sets the command for 1st gallery item  <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for 2nd gallery item <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for 3rd gallery item <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for 4th gallery item <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for 5th gallery item <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for 6th gallery item <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for 7th gallery item <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for 8th gallery item <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for 9th gallery item <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for 10th gallery item <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for 11th gallery item <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for 12th gallery item <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for 13th gallery item <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for richTextBox PreviewMouseLeftButtonUp <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for richText box selection changed <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for remove button <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the command for minimize ribbon button <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Sets the command for the selected font in <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        public ICommand SelectedFontCommand { get { return selectedFontCommand; } }

        /// <summary>
        /// Gets or sets the command for button <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>      
        public ICommand ButtonCommand { get { return buttonCommand; } }

        /// <summary>
        /// Gets or sets the command for dropdown <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>      
        public ICommand DropDownCommand { get { return dropdownCommand; } }

        /// <summary>
        /// Gets or sets the command for saveas backstage command button <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        public ICommand SaveAsCommand { get { return saveAsCommand; } }

        /// <summary>
        /// Gets or sets the command for open backstage command button <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        public ICommand OpenCommand { get { return openCommand; } }

        /// <summary>
        /// Gets or sets the command for close backstage command button <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        public ICommand CloseCommand { get { return closeCommand; } }

        /// <summary>
        /// Gets or sets the command for backStage exit button <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        public ICommand BackStageExitCommand { get { return backStageExitCommand; } }

        /// <summary>
        /// Gets or sets the command for return to editor button in info backstage <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        public ICommand ReturnToEditorCommand { get { return returnToEditorCommand; } }

        /// <summary>
        /// Gets or sets the command for online help button in help backstage <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        public ICommand OnlineHelpCommand { get { return onlineHelpCommand; } }

        /// <summary>
        /// Gets or sets the command for online getting started button in help backstage <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        public ICommand GettingStartedHelpCommand { get { return gettingStartedHelpCommand; } }

        /// <summary>
        /// Gets or sets the font.family for the ItemSource of RibbonComboBox Control <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the font.size for the ItemSource of the RibbonComboBox Control <see cref="SimplifiedRibbonViewModel"/> class.
        /// </summary>
        ...
        /// </summary>
        /// <param name="parameter">Specifies the object type parameter.</param>
        private void ExecuteSelectedFontCommand(object parameter)
        {
            GettingStartedModel gettingStartedModel = parameter as GettingStartedModel;
            if(gettingStartedModel != null)
            {
                if (gettingStartedModel.FontSize > 0)
                    SelectionFontSize = gettingStartedModel.FontSize;
                if (gettingStartedModel.FontFamily != null)
                    SelectionFontFamily = new FontFamily(gettingStartedModel.FontFamily);
            }
        }
        ...
        {
            SimplifiedRibbon simplifiedRibbonDemosView = parameter as SimplifiedRibbon;
            if (simplifiedRibbonDemosView != null)
            {
                simplifiedRibbonDemosView.Close();
            }
