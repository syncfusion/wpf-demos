...
namespace syncfusion.ribbondemos.wpf
{
    ...
    /// </summary>
    public partial class SimplifiedRibbon
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SimplifiedRibbon"/> class.
        /// </summary>
        ...
        protected override void OnClosing(CancelEventArgs e)
        {
            ...
            var viewModel = this.DataContext as SimplifiedRibbonViewModel;
            if (viewModel != null)
            {               
                viewModel.Dispose();
                viewModel = null;
