   ...
   public class RichTextBoxDemosViewModel : DemoBrowserViewModel
    ...
    public class RichTextBoxProductDemos : ProductDemo
    {
        ...
        public RichTextBoxProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Right to Left", GroupName = "LOCALIZATION", Title = "Right to Left", Description = "This sample illustrates document editor fully localized for Right-to-left language using SfRichTextBoxAdv control.", DemoViewType = typeof(RightToLeftDemo), ThemeMode = ThemeMode.Inherit, DemoLauchMode = DemoLauchMode.Window, Tag = Tag.New });
            this.Demos.Add(new DemoInfo() { SampleName = "Localization", GroupName = "LOCALIZATION", Title = "Localization", Description = "This sample illustrates localized document editor by using SfRichTextBoxAdv control with a set of resource manager files.", DemoViewType = typeof(LocalizationDemo), ThemeMode = ThemeMode.Inherit, DemoLauchMode = DemoLauchMode.Window, Tag = Tag.New });
        }
    }
}
