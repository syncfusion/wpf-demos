...
#endif
            //ShowcaseDemos
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.weatheranalysis.wpf.WeatherAnalysisDemo), SampleName = "Weather Analysis", ImagePath = "/syncfusion.weatheranalysis.wpf;component/Assets/WeatherAnalysis/WeatherAnalysis.png", IsShowcase = true, Tag = Tag.Updated });
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.stockanalysisdemo.wpf.StockAnalysisDemo), SampleName = "Stock Analysis", ImagePath = "/syncfusion.stockanalysisdemo.wpf;component/Assets/StockAnalysis.png", IsShowcase = true, Tag = Tag.Updated });
