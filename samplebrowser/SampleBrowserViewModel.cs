...
namespace syncfusion.samplebrowser.wpf
{
    public class SamplesViewModel : DemoBrowserViewModel
    {
        public override List<ProductDemo> GetDemosDetails()
        {
...
#endif
            //ShowcaseDemos
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.expenseanalysis.wpf.ExpenseAnalysisDemo), SampleName = "Expense Analysis", ImagePath = "/syncfusion.expenseanalysis.wpf;component/Assets/ExpenseAnalysis/ExpenseAnalysis.png", IsShowcase = true, Tag = Tag.Updated });
            ...
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.stockanalysisdemo.wpf.StockAnalysisDemo), SampleName = "Stock Analysis", ImagePath = "/syncfusion.stockanalysisdemo.wpf;component/Assets/StockAnalysis.png" });
