...
namespace syncfusion.samplebrowser.wpf
{
    public class SamplesViewModel : DemoBrowserViewModel
    {
        public override List<ProductDemo> GetDemosDetails()
        {
            ...
            productdemos.Add(new syncfusion.notificationdemos.wpf.NotifyIconProductDemos());
            ...
            this.ShowcaseDemos.Add(new DemoInfo() { DemoViewType = typeof(syncfusion.organizationallayout.wpf.Organizationallayout), SampleName = "Organizational Layout", ImagePath = "/syncfusion.organizationallayout.wpf;component/Asset/organization.png" });
