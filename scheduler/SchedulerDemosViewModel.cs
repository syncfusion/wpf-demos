...
namespace syncfusion.schedulerdemos.wpf
{
    ...
    public class SchedulerProductDemos : ProductDemo
    {
        public SchedulerProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Timeline views", Description = "This sample showcases the SfScheduler Timeline day , Timeline week , Timeline work week and Timeline month views.", GroupName = "GETTING STARTED", DemoViewType = typeof(TimelineViewsDemo) });

            this.Demos.Add(new DemoInfo() { SampleName = "Appointment", ThemeMode = ThemeMode.Default, Description = "This sample showcases the customization capabilities of the scheduler appointment control.", GroupName = "CUSTOMIZATION", DemoViewType = typeof(AppointmentCustomizationDemo) });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Fare Calendar ", ThemeMode= ThemeMode.Default, Description = "This sample showcases the customization capabilities of a scheduler month cell.", GroupName = "CUSTOMIZATION", DemoViewType = typeof(MonthCellCustomizationDemo) });
            this.Demos.Add(new DemoInfo() { SampleName = "Speical Time Region", ThemeMode = ThemeMode.Default, Description = "This sample showcases how to add the SpecialTimeRegion and customize its appearance using the DataTemplate in SfScheduler. The SpecialTimeRegion is used for restricting user interactions such as selection, highlighting specific regions of time, and editing data in the scheduler.", GroupName = "CUSTOMIZATION", DemoViewType = typeof(SpecialTimeRegionCustomizationDemo) });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Load on demand", GroupName = "LOAD ON DEMAND", Description = "This sample showcases the appointment on demand loading capability of the SfScheduler with custom data binding.", DemoViewType = typeof(LoadOnDemandDemo) });
            this.Demos.Add(new DemoInfo() { SampleName = "Reminder", GroupName = "REMINDER", Description = "This sample showcases the SfScheduler appointment reminder feature with custom data binding.", DemoViewType = typeof(ReminderDemo) });
