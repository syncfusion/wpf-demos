...
namespace syncfusion.schedulerdemos.wpf
{
    ...
    public class SchedulerProductDemos : ProductDemo
    {
        public SchedulerProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Timeline views", Description = "This sample showcases the scheduler timeline day, timeline week, timeline work week and timeline month views.", GroupName = "GETTING STARTED", DemoViewType = typeof(TimelineViewsDemo) });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Recurring Appointments", Description = "This sample showcases the capabilities of creating recurring appointments on daily, weekly, monthly, and yearly intervals in all scheduler views.", GroupName = "APPOINTMENTS", DemoViewType = typeof(RecurringAppointmentsDemo) });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Resource", Description = "This sample showcases the capabilities to display or group appointments based on the resources in timeslot views, resource grouping types in day, week, workweek views and resource view customization.", GroupName = "RESOURCES", DemoViewType = typeof(ResourceDemo) });
