...
namespace syncfusion.schedulerdemos.wpf
{
    ...
    public class SchedulerProductDemos : ProductDemo
    {
        public SchedulerProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Timeline views", Tag = Tag.New, Description = "This sample showcases the SfScheduler Timeline day , Timeline week , Timeline work week and Timeline month views.", GroupName = "GETTING STARTED", DemoViewType = typeof(TimelineViewsDemo) });

            this.Demos.Add(new DemoInfo() { SampleName = "Appointment", ThemeMode = ThemeMode.Default, Tag = Tag.Updated, Description = "This sample showcases the customization capabilities of the scheduler appointment control.", GroupName = "CUSTOMIZATION", DemoViewType = typeof(AppointmentCustomizationDemo) });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Fare Calendar ", ThemeMode= ThemeMode.Default, Tag = Tag.Updated, Description = "This sample showcases the customization capabilities of a scheduler month cell.", GroupName = "CUSTOMIZATION", DemoViewType = typeof(MonthCellCustomizationDemo) });
            this.Demos.Add(new DemoInfo() { SampleName = "Speical Time Region", Tag = Tag.Updated ,Description = "This sample showcases how to add the SpecialTimeRegion and customize its appearance using the DataTemplate in SfScheduler. The SpecialTimeRegion is used for restricting user interactions such as selection, highlighting specific regions of time, and editing data in the scheduler.", GroupName = "CUSTOMIZATION", DemoViewType = typeof(SpecialTimeRegionCustomizationDemo) });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Resource", GroupName = "RESOURCES", Description = "This sample showcases the following capabilities of the SfScheduler.\n \u2022 Display or group appointments based on different resources.\n \u2022 Display the resources when the scheduler is grouped by either resource or date\n \u2022 Customize the resource view by using the DataTemplate \n \u2022 Map custom resources and appointments data for scheduler resources.", DemoViewType = typeof(ResourceDemo) });
            this.Demos.Add(new DemoInfo() { SampleName = "Load on demand", Tag = Tag.New, GroupName = "LOAD ON DEMAND", Description = "This sample showcases the appointment on demand loading capability of the SfScheduler with custom data binding.", DemoViewType = typeof(LoadOnDemandDemo) });
            this.Demos.Add(new DemoInfo() { SampleName = "Reminder", Tag = Tag.New, GroupName = "REMINDER", Description = "This sample showcases the SfScheduler appointment reminder feature with custom data binding.", DemoViewType = typeof(ReminderDemo) });
            this.Demos.Add(new DemoInfo() { SampleName = "Drag and Drop", GroupName = "DRAG AND DROP", Description = "Scheduler allows drag and drop the appointments in all views and this sample showcases the drag and drop behavior between ListView and Scheduler.", DemoViewType = typeof(DragandDropDemo)});
        }
    }
}
