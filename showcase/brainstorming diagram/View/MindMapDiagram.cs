...
namespace syncfusion.brainstormingdiagram.wpf
{
    public class MindMapDiagram : SfDiagram
    {
        ...
        {
            SetResourceReference(StyleProperty, typeof(MindMapDiagram));
        ...
        {
            if (!(e.Property.Name == "CommandManager" && e.NewValue == null))
            {
        ...
        {
            return new syncfusion.brainstormingdiagram.wpf.View.QuickCommand();
        }
        protected override Syncfusion.UI.Xaml.Diagram.Node GetNodeForItemOverride(object item)
        {
            if (item is syncfusion.brainstormingdiagram.wpf.ViewModel.Root)
            {
                return new syncfusion.brainstormingdiagram.wpf.View.Root();
            }
            else
            {
                return new syncfusion.brainstormingdiagram.wpf.View.Child();
            }
        }
        #endregion
        ...
        private IEnumerable<Type> GetKnownTypes()
        {
            List<Type> known = new List<Type>()
            {
                ...
                typeof(FontWeight),
                typeof(syncfusion.brainstormingdiagram.wpf.ViewModel.Child),
                typeof(syncfusion.brainstormingdiagram.wpf.ViewModel.RootChild),
                typeof(syncfusion.brainstormingdiagram.wpf.ViewModel.Root),
                typeof(TextWrapping),
                typeof (Syncfusion.UI.Xaml.Diagram.Layout.RootChildDirection)
            };
