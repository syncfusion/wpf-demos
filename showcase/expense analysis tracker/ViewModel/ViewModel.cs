...
namespace syncfusion.expenseanalysis.wpf
{
    internal class ViewModel : NotificationObject
    {
        ...
        private object comboBoxViewSelectedItem;

        public object ComboBoxViewSelectedItem
        {
            get { return comboBoxViewSelectedItem; }
            set
            {
                comboBoxViewSelectedItem = value;
                RaisePropertyChanged("ComboBoxViewSelectedItem");
                this.ComboBoxViewSelectedItemUpdate();
            }
        }

        private object comboBoxExportSelectedItem = "Excel";

        public object ComboBoxExportSelectedItem
        {
            get { return comboBoxExportSelectedItem; }
            set
            {
                comboBoxExportSelectedItem = value;
                RaisePropertyChanged("ComboBoxExportSelectedItem");                
            }
        }
        ...
        private void ComboBoxViewSelectedItemUpdate()
        {
            var view = ComboBoxViewSelectedItem == null ? "Grid" : (ComboBoxViewSelectedItem as ComboBoxItemAdv).Content.ToString();
            if (view == "Grid")
                CurrentView = new GridView();
            else
