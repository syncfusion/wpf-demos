...
{
    public class NANDGateViewModel : GateViewModel
    {
        public NANDGateViewModel() : base()
        {
        ...
        {
            this.ContentTemplate = this.DiagramModel == null || this.DiagramModel.View == null ? null : this.DiagramModel.View.Resources[Constants.NANDGate] as DataTemplate;
        }
    }
}
