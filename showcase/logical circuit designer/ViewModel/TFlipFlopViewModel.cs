...
{
    public class TFlipFlopViewModel : GateViewModel
    {
        public TFlipFlopViewModel() : base()
        {
        ...
        protected override void GenerateLogic()
        {
            ...
            {
                int tinput = (int)(nodeInfo.InConnectors.ElementAt(0) as WireViewModel).State;
                ...
                FindOutput(tinput, clockinput, presetinput, clearinput);
            }
        }

        protected override void RefreshTemplate()
        {
            this.ContentTemplate = this.DiagramModel == null || this.DiagramModel.View == null ? null : this.DiagramModel.View.Resources[Constants.TFlipFlop] as DataTemplate;
        }

        private void FindOutput(int tinput, int clockinput, int presetinput, int clearinput)
        {
            string value = tinput.ToString() + clockinput.ToString() + presetinput.ToString() + clearinput.ToString();
