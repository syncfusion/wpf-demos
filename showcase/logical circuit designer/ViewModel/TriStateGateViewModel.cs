...
{
    public class TriStateGateViewModel : GateViewModel
    {
        public TriStateGateViewModel() : base()
        {
        ...
        {
            this.ContentTemplate = this.DiagramModel == null || this.DiagramModel.View == null ? null : this.DiagramModel.View.Resources[Constants.TriState] as DataTemplate;
        }
    }
}
