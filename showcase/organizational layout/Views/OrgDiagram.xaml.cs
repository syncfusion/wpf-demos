...
{
 public sealed partial class OrganizationDiagram : UserControl
    {
        #region Variables
        ...
        void sfdiagram_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            (sfdiagram.Info as IGraphInfo).Commands.Zoom.Execute(new ZoomPositionParameter()
            {
                ZoomTo = 0.8,
        ...
        private void UpdateCollection()
        {
            ...
            XDocument loadedData = XDocument.Load(@"Data/Diagram/Employee.xml");
      ...
      private string IsCheck(XAttribute xAttribute)
        ...
        public static readonly DependencyProperty ChartViewModelProperty =
            DependencyProperty.Register("ChartViewModel", typeof(ChartViewModel), typeof(OrganizationDiagram), new PropertyMetadata(null, OnPropertyChangedCallBack));

        private static void OnPropertyChangedCallBack(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            OrganizationDiagram diagram = d as OrganizationDiagram;
