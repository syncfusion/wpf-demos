...
namespace syncfusion.organizationallayout.wpf
{
    ...
    public partial class TemplateFileButton : UserControl, INotifyPropertyChanged
    {
        ...
        private string folderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Organizational Layout");
        private string fileName = string.Empty;
        private string _imagepath = "/syncfusion.organizationallayout.wpf;component/Asset/moreinfo.png";
