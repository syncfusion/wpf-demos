...
namespace syncfusion.organizationallayout.wpf
{
    ...
    public partial class ZoomPanWindow : ChromelessWindow
    {
        ...
        {
            ZoomParameter param = (this.DataContext as organizationallayoutViewModel).ZoomParameter;
            ...
            (this.DataContext as organizationallayoutViewModel).OnZoomCommand(this.textbox.Text);
