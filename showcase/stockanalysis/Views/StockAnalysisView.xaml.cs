    ...
    public partial class StockAnalysisView : UserControl
    {
                ...
                case 3:
                    {
                        ...
                        DataTemplate hiLoOpenCloseToolTipTemplate = (DataTemplate)FindResource("ToolTipTemplate"); 
                        hiLoOpenClose.TooltipTemplate = hiLoOpenCloseToolTipTemplate; 
                ...
                case 4:
                    {
                        ...
                        DataTemplate hollowSeriesToolTipTemplate = (DataTemplate)FindResource("ToolTipTemplate");
                        hollowSeries.TooltipTemplate = hollowSeriesToolTipTemplate;
        ...
        private void ZoomIn1_Click(object sender, RoutedEventArgs e)
        {
            foreach (var item in financialChart.Axes)
            {
                ...
                if (axis != null && item is DateTimeCategoryAxis)
                {
