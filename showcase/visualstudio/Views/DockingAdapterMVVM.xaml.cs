...
{
    /// <summary>
    /// Interaction logic for DockingAdapterMVVM.xaml
    /// </summary>
    public partial class DockingAdapterMVVM : UserControl
    {
        public DockingAdapterMVVM()
        {
            InitializeComponent();
        }
        ...
        public static readonly DependencyProperty ItemsSourceProperty =
            DependencyProperty.Register("ItemsSource", typeof(IList), typeof(DockingAdapterMVVM), new PropertyMetadata(null, new PropertyChangedCallback(OnItemSourcePropertyChanged)));
        ...
        public static readonly DependencyProperty UseDocumentContainerProperty =
            DependencyProperty.Register("UseDocumentContainer", typeof(bool), typeof(DockingAdapterMVVM), new PropertyMetadata(false, new PropertyChangedCallback(OnUseDocumentContainerChanged)));

        private static void OnUseDocumentContainerChanged(DependencyObject sender, DependencyPropertyChangedEventArgs args)
        {
            DockingAdapterMVVM adapter = sender as DockingAdapterMVVM;
            if (adapter != null)
            {
        ...
        {
            DockingAdapterMVVM instance = (DockingAdapterMVVM)d;
            if (instance != null)
            {
                if (e.OldValue != null)
                {
