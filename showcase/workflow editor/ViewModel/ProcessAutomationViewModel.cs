...
namespace syncfusion.workfloweditor.wpf
{
    public class ProcessAutomationViewModel : DiagramCommonViewModel
    {
        ...
        {
            get { return m_MinimizeCommand; }
            set
            {
                if (m_MinimizeCommand != value)
                {
                    m_MinimizeCommand = value;
                    OnPropertyChanged("MinimizeCommand");
                }
            }
        }

        private ICommand m_ToggleMaximizeCommand;

        public ICommand ToggleMaximizeCommand
        {
            get { return m_ToggleMaximizeCommand; }
            set
            {
                if (m_ToggleMaximizeCommand != value)
                {
                    m_ToggleMaximizeCommand = value;
                    OnPropertyChanged("ToggleMaximizeCommand");
                }
            }
        }
