...
namespace syncfusion.spreadsheetdemos.wpf
{
    ...
    public class SpreadsheetProductDemos : ProductDemo
    {
        public SpreadsheetProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Chart", Description = "This sample showcases how to import the Excel chart into the SfSpreadsheet.", GroupName = "DATA VISUALIZAATION", DemoViewType = typeof(ChartDemo), DemoLauchMode = DemoLauchMode.Window, Documentations = chartDocumentation });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Sparklines", Description = "This sample showcases the Sparkline importing support in the SfSpreadsheet", GroupName = "DATA VISUALIZAATION", DemoViewType = typeof(SparklinesDemo), DemoLauchMode = DemoLauchMode.Window, Documentations = sparklinesDocumentation });
