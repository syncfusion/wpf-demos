...
namespace syncfusion.treegriddemos.wpf
{
    ...
    public class TreeGridProductDemos : ProductDemo
    {
        public TreeGridProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Cell Selection", Tag = Tag.New, Description = "This sample showcases the cell selection capability of SfTreeGrid. SfTreeGrid control provides an interactive support for selecting cells in different mode with smooth and ease manner. It supports to select a specific cell or group of cells programmatically or by Mouse and Keyboard interactions by SelectionMode property. This property provides options like Single, SingleDeselect, Multiple, Extended and None.", GroupName = "EDITING AND SELECTION", DemoViewType = typeof(CellSelectionDemo), Documentations = cellSelectionDocumentation });
