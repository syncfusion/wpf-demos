...
namespace syncfusion.treegriddemos.wpf
{
    ...
    public class TreeGridProductDemos : ProductDemo
    {
        public TreeGridProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Conditional CheckBox", Description = "This sample showcases how to show CheckBox based on some conditions in SfTreeGrid.", GroupName = "NODE CHECKBOX", DemoViewType = typeof(ConditionalCheckBox), ThemeMode = ThemeMode.Default });
