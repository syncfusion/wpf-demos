...
namespace syncfusion.treegriddemos.wpf
{
    ...
    public class TreeGridProductDemos : ProductDemo
    {
        public TreeGridProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Search", Tag = Tag.New, Description = "This sample showcases the search support of SfTreeGrid. This allows you to search the TreeGrid with operations to filter and highlight the search text in cells.", GroupName = "FILTERING", DemoViewType = typeof(SearchPanelDemo), Documentations = searchDocumentation });

            List<Documentation> rowSelectionDocumentation = new List<Documentation>();
            rowSelectionDocumentation.Add(new Documentation { Content = "TreeGrid - SelectionMode API Reference", Uri = new Uri("https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.Grid.SfGridBase.html#Syncfusion_UI_Xaml_Grid_SfGridBase_SelectionMode") });
            rowSelectionDocumentation.Add(new Documentation { Content = "TreeGrid - NavigationMode API Reference", Uri = new Uri("https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.Grid.SfGridBase.html#Syncfusion_UI_Xaml_Grid_SfGridBase_NavigationMode") });
            rowSelectionDocumentation.Add(new Documentation { Content = "TreeGrid - Row Selection Documentation", Uri = new Uri("https://help.syncfusion.com/wpf/treegrid/selection#row-selection") });
            this.Demos.Add(new DemoInfo() { SampleName = "Row Selection", Description= "This sample showcases the row selection capability of SfTreeGrid. SfTreeGrid control provides an interactive support for selecting rows in different mode with smooth and ease manner. It supports to select a specific row or group of rows programmatically or by Mouse and Keyboard interactions by SelectionMode property. This property provides options like Single, SingleDeselect, Multiple, Extended and None.", GroupName = "EDITING AND SELECTION", DemoViewType = typeof(SelectionDemo), Documentations = rowSelectionDocumentation });

            List<Documentation> cellSelectionDocumentation = new List<Documentation>();
            cellSelectionDocumentation.Add(new Documentation { Content = "TreeGrid - Cell Selection Documentation", Uri = new Uri("https://help.syncfusion.com/wpf/treegrid/selection#cell-selection") });
            this.Demos.Add(new DemoInfo() { SampleName = "Cell Selection",  Description = "This sample showcases the cell selection capability of SfTreeGrid. SfTreeGrid control provides an interactive support for selecting cells in different mode with smooth and ease manner. It supports to select a specific cell or group of cells programmatically or by Mouse and Keyboard interactions by SelectionMode property. This property provides options like Single, SingleDeselect, Multiple, Extended and None.", GroupName = "EDITING AND SELECTION", DemoViewType = typeof(CellSelectionDemo), Documentations = cellSelectionDocumentation });

            List<Documentation> autoRowHeightDocumentation = new List<Documentation>();
            autoRowHeightDocumentation.Add(new Documentation { Content = "TreeGrid - Row Height Documentation", Uri = new Uri("https://help.syncfusion.com/wpf/treegrid/rows") });
            this.Demos.Add(new DemoInfo() { SampleName = "Auto RowHeight", Tag = Tag.New, Description = "This sample showcases the auto row height feature of SfTreeGrid which improves the readability of the content. Provides support to change the height of the row based on its content on-demand based for all columns or certain columns of SfTreeGrid.", GroupName = "ROWS", DemoViewType = typeof(AutoRowHeightDemo), Documentations = autoRowHeightDocumentation });
            ...
            List<Documentation> treeGridPagingDocumentation = new List<Documentation>();
            treeGridPagingDocumentation.Add(new Documentation { Content = "SfDataPager API Reference", Uri = new Uri("https://help.syncfusion.com/cr/wpf/Syncfusion.UI.Xaml.Controls.DataPager.SfDataPager.html") });
            this.Demos.Add(new DemoInfo() { SampleName = "Data Paging", Tag = Tag.New, ThemeMode = ThemeMode.None, Description = "This sample showcases the paging capability of SfTreeGrid. Paging support is achieved using the SfDataPager control, which returns pages of RootNodes, and page selection can be done through numbered buttons. The entire data collection is loaded into the SfDataPager, and bind the PagedSource property of the SfDataPager to the ItemsSource property of SfTreeGrid.", GroupName = "DATA VIRTUALIZATION", DemoViewType = typeof(TreeGridPagingDemo), Documentations = treeGridPagingDocumentation });
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Serialization", GroupName = "SERIALIZATION", Description = "This sample showcases the serialization and deserialization capability of SfTreeGrid. By customizing SerializationController, you can serialize and deserialize derived TreeGrid and custom column also.", DemoViewType = typeof(SerializationDemo), ThemeMode = ThemeMode.None, Documentations = serializationDocumentation });
