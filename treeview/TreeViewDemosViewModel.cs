...
namespace syncfusion.treeviewdemos.wpf
{
    ...
    public class TreeViewProductDemos : ProductDemo
    {
        public TreeViewProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Editing", GroupName = "INTERACTIVE FEATURES", Description = "This sample showcases the editing capability in SfTreeView. You can start editing by navigating to required treeview item and press the F2 key.", ThemeMode = ThemeMode.Default, DemoViewType = typeof(EditingDemo), Tag = Tag.New});
