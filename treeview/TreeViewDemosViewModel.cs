...
namespace syncfusion.treeviewdemos.wpf
{
    ...
    public class TreeViewProductDemos : ProductDemo
    {
        public TreeViewProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Filtering", Tag = Tag.Updated, GroupName = "DATA", Description = "This sample showcases the ListCollectionView binding with filtering support of SfTreeView. If the filtered item does not exist in the SfTreeView, the EmptyContent object is displayed as \"No results found\".", ThemeMode = ThemeMode.Inherit, DemoViewType = typeof(FilteringDemo) });
