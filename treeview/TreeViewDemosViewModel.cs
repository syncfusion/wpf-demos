...
namespace syncfusion.treeviewdemos.wpf
{
    ...
    public class TreeViewProductDemos : ProductDemo
    {
        public TreeViewProductDemos()
        {
            ...
            this.Demos.Add(new DemoInfo() { SampleName = "Filtering", GroupName = "DATA", Description = "This sample showcases the ListCollectionView binding with filtering support of SfTreeView.", ThemeMode = ThemeMode.Inherit,Tag=Tag.New, DemoViewType = typeof(FilteringDemo) });
