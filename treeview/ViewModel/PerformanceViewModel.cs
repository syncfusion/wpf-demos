...
namespace syncfusion.treeviewdemos.wpf
{
    public class PerformanceViewModel : INotifyPropertyChanged
    {
        ...
        {
            ClickCommand = new demoscommon.wpf.DelegateCommand<object>(ExecuteClickAction, CanExecuteClickCommand);
            TreeViewOnDemandCommand = new demoscommon.wpf.DelegateCommand<object>(ExecuteOnDemandLoading, CanExecuteOnDemandLoading);
        }
        #endregion
